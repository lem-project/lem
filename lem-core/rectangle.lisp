...
(define-key *global-keymap* "C-x Spc" 'rectangle-mark-mode)
...
(define-rectangle-movable-command prev-line arg)
(define-rectangle-movable-command next-char arg)
(define-rectangle-movable-command prev-char arg)
(define-rectangle-movable-command next-word arg)
(define-rectangle-movable-command prev-word arg)
