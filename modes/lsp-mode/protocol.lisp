...
#+sbcl (sb-ext:lock-package :lem-lsp-mode/protocol)

(COMMON-LISP:DEFCLASS MESSAGE (LEM-LSP-MODE/JSON:OBJECT) ((JSONRPC :INITARG :JSONRPC :DOCUMENTATION "" :TYPE COMMON-LISP:STRING)))
...
(COMMON-LISP:DEFCLASS LOCATION (LEM-LSP-MODE/JSON:OBJECT)
                      ((URI :INITARG :URI :DOCUMENTATION "" :TYPE DOCUMENT-URI) (RANGE :INITARG :RANGE :DOCUMENTATION "" :TYPE RANGE)))
...
*
* @since 3.15.0"
                        :TYPE (LEM-LSP-MODE/TYPE:TS-ARRAY DIAGNOSTIC-TAG))
                       (RELATED-INFORMATION? :INITARG :RELATED-INFORMATION :DOCUMENTATION "*
* An array of related diagnostic information, e.g. when symbol-names within
* a scope collide all definitions can be marked via this property."
                        :TYPE (LEM-LSP-MODE/TYPE:TS-ARRAY DIAGNOSTIC-RELATED-INFORMATION))))
...
* invoked with."
                        :TYPE (LEM-LSP-MODE/TYPE:TS-ARRAY COMMON-LISP:T))))
...
* The edits to be applied."
                        :TYPE (LEM-LSP-MODE/TYPE:TS-ARRAY TEXT-EDIT))))
...
* A create"
                        :TYPE (LEM-LSP-MODE/TYPE:TS-EQUAL-SPECIALIZER "create"))
...
(COMMON-LISP:DEFCLASS RENAME-FILE (LEM-LSP-MODE/JSON:OBJECT)
                      ((KIND :INITARG :KIND :DOCUMENTATION "*
* A rename"
                        :TYPE (LEM-LSP-MODE/TYPE:TS-EQUAL-SPECIALIZER "rename"))
...
(COMMON-LISP:DEFCLASS DELETE-FILE (LEM-LSP-MODE/JSON:OBJECT)
                      ((KIND :INITARG :KIND :DOCUMENTATION "*
* A delete"
                        :TYPE (LEM-LSP-MODE/TYPE:TS-EQUAL-SPECIALIZER "delete"))
                       (URI :INITARG :URI :DOCUMENTATION "*
* The file to delete."
                        :TYPE DOCUMENT-URI)
                       (OPTIONS? :INITARG :OPTIONS :DOCUMENTATION "*
...
* Holds changes to existing resources."
                        ...
                        (LEM-LSP-MODE/TYPE:TS-INTERFACE
                         ("uri" :TYPE (LEM-LSP-MODE/TYPE:TS-OBJECT DOCUMENT-URI (LEM-LSP-MODE/TYPE:TS-ARRAY TEXT-EDIT)))))
...
*
* @since 3.13.0"
                        :TYPE (LEM-LSP-MODE/TYPE:TS-ARRAY RESOURCE-OPERATION-KIND))
...
(COMMON-LISP:DEFCLASS WORK-DONE-PROGRESS-BEGIN (LEM-LSP-MODE/JSON:OBJECT)
                      ((KIND :INITARG :KIND :DOCUMENTATION "" :TYPE (LEM-LSP-MODE/TYPE:TS-EQUAL-SPECIALIZER "begin"))
                       (TITLE :INITARG :TITLE :DOCUMENTATION "*
...
(COMMON-LISP:DEFCLASS WORK-DONE-PROGRESS-REPORT (LEM-LSP-MODE/JSON:OBJECT)
                      ((KIND :INITARG :KIND :DOCUMENTATION "" :TYPE (LEM-LSP-MODE/TYPE:TS-EQUAL-SPECIALIZER "report"))
                       (CANCELLABLE? :INITARG :CANCELLABLE :DOCUMENTATION "*
...
(COMMON-LISP:DEFCLASS WORK-DONE-PROGRESS-END (LEM-LSP-MODE/JSON:OBJECT)
                      ((KIND :INITARG :KIND :DOCUMENTATION "" :TYPE (LEM-LSP-MODE/TYPE:TS-EQUAL-SPECIALIZER "end"))
                       (MESSAGE? :INITARG :MESSAGE :DOCUMENTATION "*
...
(COMMON-LISP:DEFCLASS WORK-DONE-PROGRESS-OPTIONS (LEM-LSP-MODE/JSON:OBJECT)
                      ((WORK-DONE-PROGRESS? :INITARG :WORK-DONE-PROGRESS :DOCUMENTATION "" :TYPE COMMON-LISP:BOOLEAN)))
...
*
* @since 3.15.0"
                        :TYPE (LEM-LSP-MODE/TYPE:TS-INTERFACE ("name" :TYPE COMMON-LISP:STRING) ("version" :TYPE COMMON-LISP:STRING)))
...
*
* @since 3.6.0"
                        :TYPE (COMMON-LISP:OR (LEM-LSP-MODE/TYPE:TS-ARRAY WORKSPACE-FOLDER) NULL))))
...
* Workspace specific client capabilities."
                        ...
                        (LEM-LSP-MODE/TYPE:TS-INTERFACE ("applyEdit" :TYPE COMMON-LISP:BOOLEAN)
                         ...
                         ("symbol" :TYPE WORKSPACE-SYMBOL-CLIENT-CAPABILITIES)
                         ("executeCommand" :TYPE EXECUTE-COMMAND-CLIENT-CAPABILITIES) ("workspaceFolders" :TYPE COMMON-LISP:BOOLEAN)
...
* Window specific client capabilities."
                        :TYPE (LEM-LSP-MODE/TYPE:TS-INTERFACE ("workDoneProgress" :TYPE COMMON-LISP:BOOLEAN)))
...
* Workspace specific server capabilities"
                        :TYPE (LEM-LSP-MODE/TYPE:TS-INTERFACE ("workspaceFolders" :TYPE WORKSPACE-FOLDERS-SERVER-CAPABILITIES)))
                       (EXPERIMENTAL? :INITARG :EXPERIMENTAL :DOCUMENTATION "*
...
* The message action items to present."
                        :TYPE (LEM-LSP-MODE/TYPE:TS-ARRAY MESSAGE-ACTION-ITEM))))
...
(COMMON-LISP:DEFCLASS REGISTRATION-PARAMS (LEM-LSP-MODE/JSON:OBJECT)
                      ((REGISTRATIONS :INITARG :REGISTRATIONS :DOCUMENTATION "" :TYPE (LEM-LSP-MODE/TYPE:TS-ARRAY REGISTRATION))))
...
(COMMON-LISP:DEFCLASS UNREGISTRATION-PARAMS (LEM-LSP-MODE/JSON:OBJECT)
 ...
 of the specification."
                        :TYPE (LEM-LSP-MODE/TYPE:TS-ARRAY UNREGISTRATION))))
...
* The array of added workspace folders"
                        :TYPE (LEM-LSP-MODE/TYPE:TS-ARRAY WORKSPACE-FOLDER))
...
(COMMON-LISP:DEFCLASS CONFIGURATION-PARAMS (LEM-LSP-MODE/JSON:OBJECT)
                      ((ITEMS :INITARG :ITEMS :DOCUMENTATION "" :TYPE (LEM-LSP-MODE/TYPE:TS-ARRAY CONFIGURATION-ITEM))))
...
* The watchers to register."
                        :TYPE (LEM-LSP-MODE/TYPE:TS-ARRAY FILE-SYSTEM-WATCHER))))
...
* The actual file events."
                        :TYPE (LEM-LSP-MODE/TYPE:TS-ARRAY FILE-EVENT))))
...
* Specific capabilities for the `SymbolKind` in the `workspace/symbol` request."
                        :TYPE (LEM-LSP-MODE/TYPE:TS-INTERFACE ("valueSet" :TYPE (LEM-LSP-MODE/TYPE:TS-ARRAY SYMBOL-KIND))))))
...
* The commands to be executed on the server"
                        :TYPE (LEM-LSP-MODE/TYPE:TS-ARRAY COMMON-LISP:STRING))))
...
*   you receive them."
                        :TYPE (LEM-LSP-MODE/TYPE:TS-ARRAY TEXT-DOCUMENT-CONTENT-CHANGE-EVENT))))
...
*
* @since 3.15.0"
                        :TYPE (LEM-LSP-MODE/TYPE:TS-INTERFACE ("valueSet" :TYPE (LEM-LSP-MODE/TYPE:TS-ARRAY DIAGNOSTIC-TAG))))
...
* An array of diagnostic information items."
                        :TYPE (LEM-LSP-MODE/TYPE:TS-ARRAY DIAGNOSTIC))))
...
* capabilities."
                        ...
                        (LEM-LSP-MODE/TYPE:TS-INTERFACE ("snippetSupport" :TYPE COMMON-LISP:BOOLEAN)
                         ("commitCharactersSupport" :TYPE COMMON-LISP:BOOLEAN)
                         ("documentationFormat" :TYPE (LEM-LSP-MODE/TYPE:TS-ARRAY MARKUP-KIND))
                         ("deprecatedSupport" :TYPE COMMON-LISP:BOOLEAN) ("preselectSupport" :TYPE COMMON-LISP:BOOLEAN)
                         ("tagSupport" :TYPE
                          (LEM-LSP-MODE/TYPE:TS-INTERFACE ("valueSet" :TYPE (LEM-LSP-MODE/TYPE:TS-ARRAY COMPLETION-ITEM-TAG))))))
                       (COMPLETION-ITEM-KIND? :INITARG :COMPLETION-ITEM-KIND :DOCUMENTATION "" :TYPE
                        (LEM-LSP-MODE/TYPE:TS-INTERFACE ("valueSet" :TYPE (LEM-LSP-MODE/TYPE:TS-ARRAY COMPLETION-ITEM-KIND))))
...
* The completion items."
                        :TYPE (LEM-LSP-MODE/TYPE:TS-ARRAY COMPLETION-ITEM))))
...
*
* @since 3.15.0"
                        :TYPE (LEM-LSP-MODE/TYPE:TS-ARRAY COMPLETION-ITEM-TAG))
...
* property. The order describes the preferred format of the client."
                        :TYPE (LEM-LSP-MODE/TYPE:TS-ARRAY MARKUP-KIND))))
...
* The hover's content"
                        :TYPE (COMMON-LISP:OR MARKED-STRING (LEM-LSP-MODE/TYPE:TS-ARRAY MARKED-STRING) MARKUP-CONTENT))
                       (RANGE? :INITARG :RANGE :DOCUMENTATION "*
...
* specific properties."
                        ...
                        (LEM-LSP-MODE/TYPE:TS-INTERFACE ("documentationFormat" :TYPE (LEM-LSP-MODE/TYPE:TS-ARRAY MARKUP-KIND))
                         ("parameterInformation" :TYPE
                          (LEM-LSP-MODE/TYPE:TS-INTERFACE ("labelOffsetSupport" :TYPE COMMON-LISP:BOOLEAN)))))
                       (CONTEXT-SUPPORT? :INITARG :CONTEXT-SUPPORT :DOCUMENTATION "*
* The client supports to send additional context information for a
...
* request should return `null`."
                        :TYPE (LEM-LSP-MODE/TYPE:TS-ARRAY SIGNATURE-INFORMATION))
...
* The parameters of this signature."
                        :TYPE (LEM-LSP-MODE/TYPE:TS-ARRAY PARAMETER-INFORMATION))))
...
* Its intended use case is to highlight the parameter label part in the `SignatureInformation.label`."
                        :TYPE (COMMON-LISP:OR COMMON-LISP:STRING (LEM-LSP-MODE/TYPE:TS-TUPLE COMMON-LISP:NUMBER COMMON-LISP:NUMBER)))
                       (DOCUMENTATION? :INITARG :DOCUMENTATION :DOCUMENTATION "*
...
(COMMON-LISP:DEFCLASS DECLARATION-REGISTRATION-OPTIONS
                      (DECLARATION-OPTIONS TEXT-DOCUMENT-REGISTRATION-OPTIONS STATIC-REGISTRATION-OPTIONS) COMMON-LISP:NIL)

(COMMON-LISP:DEFCLASS DECLARATION-PARAMS (TEXT-DOCUMENT-POSITION-PARAMS WORK-DONE-PROGRESS-PARAMS PARTIAL-RESULT-PARAMS)
                      COMMON-LISP:NIL)
...
(COMMON-LISP:DEFCLASS TYPE-DEFINITION-REGISTRATION-OPTIONS
                      (TEXT-DOCUMENT-REGISTRATION-OPTIONS TYPE-DEFINITION-OPTIONS STATIC-REGISTRATION-OPTIONS) COMMON-LISP:NIL)

(COMMON-LISP:DEFCLASS TYPE-DEFINITION-PARAMS (TEXT-DOCUMENT-POSITION-PARAMS WORK-DONE-PROGRESS-PARAMS PARTIAL-RESULT-PARAMS)
                      COMMON-LISP:NIL)
...
(COMMON-LISP:DEFCLASS IMPLEMENTATION-REGISTRATION-OPTIONS
                      (TEXT-DOCUMENT-REGISTRATION-OPTIONS IMPLEMENTATION-OPTIONS STATIC-REGISTRATION-OPTIONS) COMMON-LISP:NIL)

(COMMON-LISP:DEFCLASS IMPLEMENTATION-PARAMS (TEXT-DOCUMENT-POSITION-PARAMS WORK-DONE-PROGRESS-PARAMS PARTIAL-RESULT-PARAMS)
                      COMMON-LISP:NIL)
...
(COMMON-LISP:DEFCLASS REFERENCE-PARAMS (TEXT-DOCUMENT-POSITION-PARAMS WORK-DONE-PROGRESS-PARAMS PARTIAL-RESULT-PARAMS)
                      ((CONTEXT :INITARG :CONTEXT :DOCUMENTATION "" :TYPE REFERENCE-CONTEXT)))
...
(COMMON-LISP:DEFCLASS DOCUMENT-HIGHLIGHT-REGISTRATION-OPTIONS (TEXT-DOCUMENT-REGISTRATION-OPTIONS DOCUMENT-HIGHLIGHT-OPTIONS)
                      COMMON-LISP:NIL)

(COMMON-LISP:DEFCLASS DOCUMENT-HIGHLIGHT-PARAMS (TEXT-DOCUMENT-POSITION-PARAMS WORK-DONE-PROGRESS-PARAMS PARTIAL-RESULT-PARAMS)
                      COMMON-LISP:NIL)
...
* Children of this symbol, e.g. properties of a class."
                        :TYPE (LEM-LSP-MODE/TYPE:TS-ARRAY DOCUMENT-SYMBOL))))
...
* @since 3.8.0"
                        ...
                        (LEM-LSP-MODE/TYPE:TS-INTERFACE
                         ("codeActionKind" :TYPE
                          (LEM-LSP-MODE/TYPE:TS-INTERFACE ("valueSet" :TYPE (LEM-LSP-MODE/TYPE:TS-ARRAY CODE-ACTION-KIND))))))
...
* may list out every specific kind they provide."
                        :TYPE (LEM-LSP-MODE/TYPE:TS-ARRAY CODE-ACTION-KIND))))
...
(COMMON-LISP:DEFCLASS DOCUMENT-COLOR-REGISTRATION-OPTIONS
                      (TEXT-DOCUMENT-REGISTRATION-OPTIONS STATIC-REGISTRATION-OPTIONS DOCUMENT-COLOR-OPTIONS) COMMON-LISP:NIL)
...
(COMMON-LISP:DEFCLASS DOCUMENT-FORMATTING-REGISTRATION-OPTIONS (TEXT-DOCUMENT-REGISTRATION-OPTIONS DOCUMENT-FORMATTING-OPTIONS)
                      COMMON-LISP:NIL)
...
(COMMON-LISP:DEFCLASS FOLDING-RANGE-REGISTRATION-OPTIONS
                      (TEXT-DOCUMENT-REGISTRATION-OPTIONS FOLDING-RANGE-OPTIONS STATIC-REGISTRATION-OPTIONS) COMMON-LISP:NIL)
...
(COMMON-LISP:DEFCLASS SELECTION-RANGE-REGISTRATION-OPTIONS
                      (SELECTION-RANGE-OPTIONS TEXT-DOCUMENT-REGISTRATION-OPTIONS STATIC-REGISTRATION-OPTIONS) COMMON-LISP:NIL)
...
* The positions inside the text document."
                        :TYPE (LEM-LSP-MODE/TYPE:TS-ARRAY POSITION))))
