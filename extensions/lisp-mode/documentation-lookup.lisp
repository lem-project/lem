(defpackage :lem-lisp-mode/documentation-lookup
  (:use :cl :lem)
  (:export
   :lisp-hyperspec-lookup-at-point
   :*common-lisp-hyperspec-root*))
(in-package :lem-lisp-mode/documentation-lookup)

(defvar *common-lisp-hyperspec-root* "http://www.lispworks.com/reference/HyperSpec/Body/"
  "Root url for the hyperspec, may be customized to a different hyperspec provider if desired.")
...
(define-command lisp-hyperspec-lookup-at-point () ()
  ...
  (let* ((symbol-at-point
           (string-downcase (lem:symbol-string-at-point (current-point))))
         (url (gethash symbol-at-point *common-lisp-hyperspec-symbol-table*)))
    (cond
      (url
       (trivial-open-browser:open-browser (concatenate 'string
                                                      *common-lisp-hyperspec-root*
                                                      url))
