...
(COMMON-LISP:DEFCLASS RESPONSE-MESSAGE (MESSAGE)
                      ((ID :INITARG :ID :DOCUMENTATION "*
* The request id."
                        :TYPE (COMMON-LISP:OR COMMON-LISP:NUMBER COMMON-LISP:STRING NULL) :READER
                        RESPONSE-MESSAGE-ID)
                       (RESULT? :INITARG :RESULT :DOCUMENTATION "*
* The result of a request. This member is REQUIRED on success.
* This member MUST NOT exist if there was an error invoking the method."
                        :TYPE
                        (COMMON-LISP:OR COMMON-LISP:STRING COMMON-LISP:NUMBER COMMON-LISP:BOOLEAN OBJECT NULL)
...
* information about the error. Can be omitted."
                        :TYPE
                        (COMMON-LISP:OR COMMON-LISP:STRING COMMON-LISP:NUMBER COMMON-LISP:BOOLEAN ARRAY OBJECT
                                        NULL)
...
* a scope collide all definitions can be marked via this property."
                        :TYPE (LEM-LSP-MODE/TYPE:TS-ARRAY DIAGNOSTIC-RELATED-INFORMATION) :READER
                        DIAGNOSTIC-RELATED-INFORMATION)))
...
(COMMON-LISP:DEFTYPE DIAGNOSTIC-SEVERITY ()
  '(COMMON-LISP:OR (LEM-LSP-MODE/TYPE:TS-EQUAL-SPECIALIZER 1) (LEM-LSP-MODE/TYPE:TS-EQUAL-SPECIALIZER 2)
                   (LEM-LSP-MODE/TYPE:TS-EQUAL-SPECIALIZER 3) (LEM-LSP-MODE/TYPE:TS-EQUAL-SPECIALIZER 4)))
...
*
* @since 3.13.0"
                        :TYPE (LEM-LSP-MODE/TYPE:TS-ARRAY RESOURCE-OPERATION-KIND) :READER
                        WORKSPACE-EDIT-CLIENT-CAPABILITIES-RESOURCE-OPERATIONS)
...
(COMMON-LISP:DEFTYPE RESOURCE-OPERATION-KIND ()
  '(COMMON-LISP:OR (LEM-LSP-MODE/TYPE:TS-EQUAL-SPECIALIZER "create")
                   (LEM-LSP-MODE/TYPE:TS-EQUAL-SPECIALIZER "rename")
                   (LEM-LSP-MODE/TYPE:TS-EQUAL-SPECIALIZER "delete")))
...
(COMMON-LISP:DEFTYPE FAILURE-HANDLING-KIND ()
  '(COMMON-LISP:OR (LEM-LSP-MODE/TYPE:TS-EQUAL-SPECIALIZER "abort")
                   (LEM-LSP-MODE/TYPE:TS-EQUAL-SPECIALIZER "transactional")
                   (LEM-LSP-MODE/TYPE:TS-EQUAL-SPECIALIZER "undo")
...
* undo/redo. The number doesn't need to be consecutive."
                        :TYPE (COMMON-LISP:OR COMMON-LISP:NUMBER NULL) :READER
                        VERSIONED-TEXT-DOCUMENT-IDENTIFIER-VERSION)))
...
* the document selector provided on the client side will be used."
                        :TYPE (COMMON-LISP:OR DOCUMENT-SELECTOR NULL) :READER
                        TEXT-DOCUMENT-REGISTRATION-OPTIONS-DOCUMENT-SELECTOR)))
...
(COMMON-LISP:DEFTYPE MARKUP-KIND ()
  '(COMMON-LISP:OR (LEM-LSP-MODE/TYPE:TS-EQUAL-SPECIALIZER "plaintext")
                   (LEM-LSP-MODE/TYPE:TS-EQUAL-SPECIALIZER "markdown")))
...
(COMMON-LISP:DEFCLASS WORK-DONE-PROGRESS-BEGIN (LEM-LSP-MODE/JSON:OBJECT)
                      ((KIND :INITARG :KIND :DOCUMENTATION "" :TYPE
                        (LEM-LSP-MODE/TYPE:TS-EQUAL-SPECIALIZER "begin") :READER
                        WORK-DONE-PROGRESS-BEGIN-KIND)
                       (TITLE :INITARG :TITLE :DOCUMENTATION "*
...
(COMMON-LISP:DEFCLASS WORK-DONE-PROGRESS-REPORT (LEM-LSP-MODE/JSON:OBJECT)
                      ((KIND :INITARG :KIND :DOCUMENTATION "" :TYPE
                        (LEM-LSP-MODE/TYPE:TS-EQUAL-SPECIALIZER "report") :READER
                        WORK-DONE-PROGRESS-REPORT-KIND)
                       (CANCELLABLE? :INITARG :CANCELLABLE :DOCUMENTATION "*
...
(COMMON-LISP:DEFCLASS WORK-DONE-PROGRESS-END (LEM-LSP-MODE/JSON:OBJECT)
                      ((KIND :INITARG :KIND :DOCUMENTATION "" :TYPE
                        (LEM-LSP-MODE/TYPE:TS-EQUAL-SPECIALIZER "end") :READER WORK-DONE-PROGRESS-END-KIND)
                       (MESSAGE? :INITARG :MESSAGE :DOCUMENTATION "*
...
* The initial trace setting. If omitted trace is disabled ('off')."
                        :TYPE
                        (COMMON-LISP:OR (LEM-LSP-MODE/TYPE:TS-EQUAL-SPECIALIZER "off")
                                        (LEM-LSP-MODE/TYPE:TS-EQUAL-SPECIALIZER "messages")
...
*
* @since 3.6.0"
                        :TYPE (COMMON-LISP:OR (LEM-LSP-MODE/TYPE:TS-ARRAY WORKSPACE-FOLDER) NULL) :READER
                        INITIALIZE-PARAMS-WORKSPACE-FOLDERS)))
...
* The server provides document highlight support."
                        :TYPE (COMMON-LISP:OR COMMON-LISP:BOOLEAN DOCUMENT-HIGHLIGHT-OPTIONS) :READER
                        SERVER-CAPABILITIES-DOCUMENT-HIGHLIGHT-PROVIDER)
...
* The server provides document formatting."
                        :TYPE (COMMON-LISP:OR COMMON-LISP:BOOLEAN DOCUMENT-FORMATTING-OPTIONS) :READER
                        SERVER-CAPABILITIES-DOCUMENT-FORMATTING-PROVIDER)
                       (DOCUMENT-RANGE-FORMATTING-PROVIDER? :INITARG :DOCUMENT-RANGE-FORMATTING-PROVIDER
                        :DOCUMENTATION "*
* The server provides document range formatting."
                        :TYPE (COMMON-LISP:OR COMMON-LISP:BOOLEAN DOCUMENT-RANGE-FORMATTING-OPTIONS) :READER
                        SERVER-CAPABILITIES-DOCUMENT-RANGE-FORMATTING-PROVIDER)
                       (DOCUMENT-ON-TYPE-FORMATTING-PROVIDER? :INITARG :DOCUMENT-ON-TYPE-FORMATTING-PROVIDER
                        :DOCUMENTATION "*
...
* The message action items to present."
                        :TYPE (LEM-LSP-MODE/TYPE:TS-ARRAY MESSAGE-ACTION-ITEM) :READER
                        SHOW-MESSAGE-REQUEST-PARAMS-ACTIONS)))
...
(COMMON-LISP:DEFCLASS REGISTRATION-PARAMS (LEM-LSP-MODE/JSON:OBJECT)
                      ((REGISTRATIONS :INITARG :REGISTRATIONS :DOCUMENTATION "" :TYPE
                        (LEM-LSP-MODE/TYPE:TS-ARRAY REGISTRATION) :READER REGISTRATION-PARAMS-REGISTRATIONS)))
...
(COMMON-LISP:DEFCLASS UNREGISTRATION-PARAMS (LEM-LSP-MODE/JSON:OBJECT)
 ...
 of the specification."
                        :TYPE (LEM-LSP-MODE/TYPE:TS-ARRAY UNREGISTRATION) :READER
                        UNREGISTRATION-PARAMS-UNREGISTERATIONS)))
...
* The array of added workspace folders"
                        :TYPE (LEM-LSP-MODE/TYPE:TS-ARRAY WORKSPACE-FOLDER) :READER
                        WORKSPACE-FOLDERS-CHANGE-EVENT-ADDED)
...
(COMMON-LISP:DEFCLASS CONFIGURATION-PARAMS (LEM-LSP-MODE/JSON:OBJECT)
                      ((ITEMS :INITARG :ITEMS :DOCUMENTATION "" :TYPE
                        (LEM-LSP-MODE/TYPE:TS-ARRAY CONFIGURATION-ITEM) :READER CONFIGURATION-PARAMS-ITEMS)))
...
* The watchers to register."
                        :TYPE (LEM-LSP-MODE/TYPE:TS-ARRAY FILE-SYSTEM-WATCHER) :READER
                        DID-CHANGE-WATCHED-FILES-REGISTRATION-OPTIONS-WATCHERS)))
...
* The actual file events."
                        :TYPE (LEM-LSP-MODE/TYPE:TS-ARRAY FILE-EVENT) :READER
                        DID-CHANGE-WATCHED-FILES-PARAMS-CHANGES)))
...
* Specific capabilities for the `SymbolKind` in the `workspace/symbol` request."
                        :TYPE
                        (LEM-LSP-MODE/TYPE:TS-INTERFACE
                         ("valueSet" :TYPE (LEM-LSP-MODE/TYPE:TS-ARRAY SYMBOL-KIND) :OPTIONAL-P
                          COMMON-LISP:T))
...
* The commands to be executed on the server"
                        :TYPE (LEM-LSP-MODE/TYPE:TS-ARRAY COMMON-LISP:STRING) :READER
                        EXECUTE-COMMAND-OPTIONS-COMMANDS)))
...
* Arguments that the command should be invoked with."
                        :TYPE (LEM-LSP-MODE/TYPE:TS-ARRAY COMMON-LISP:T) :READER
                        EXECUTE-COMMAND-PARAMS-ARGUMENTS)))
...
*   you receive them."
                        :TYPE (LEM-LSP-MODE/TYPE:TS-ARRAY TEXT-DOCUMENT-CONTENT-CHANGE-EVENT) :READER
                        DID-CHANGE-TEXT-DOCUMENT-PARAMS-CONTENT-CHANGES)))

(COMMON-LISP:DEFTYPE TEXT-DOCUMENT-CONTENT-CHANGE-EVENT ()
  '(COMMON-LISP:OR
    (LEM-LSP-MODE/TYPE:TS-INTERFACE ("range" :TYPE RANGE :OPTIONAL-P COMMON-LISP:NIL)
...
* @since 3.15.0"
                        :TYPE
                        (LEM-LSP-MODE/TYPE:TS-INTERFACE
                         ("valueSet" :TYPE (LEM-LSP-MODE/TYPE:TS-ARRAY DIAGNOSTIC-TAG) :OPTIONAL-P
                          COMMON-LISP:NIL))
...
* An array of diagnostic information items."
                        :TYPE (LEM-LSP-MODE/TYPE:TS-ARRAY DIAGNOSTIC) :READER
                        PUBLISH-DIAGNOSTICS-PARAMS-DIAGNOSTICS)))
...
* capabilities."
                        ...
                        (LEM-LSP-MODE/TYPE:TS-INTERFACE
                         ...
                         ("documentationFormat" :TYPE (LEM-LSP-MODE/TYPE:TS-ARRAY MARKUP-KIND) :OPTIONAL-P
                          COMMON-LISP:T)
                         ...
                         ("tagSupport" :TYPE
                          (LEM-LSP-MODE/TYPE:TS-INTERFACE
                           ("valueSet" :TYPE (LEM-LSP-MODE/TYPE:TS-ARRAY COMPLETION-ITEM-TAG) :OPTIONAL-P
                            COMMON-LISP:NIL))
                          :OPTIONAL-P COMMON-LISP:T))
                       ...
                       (COMPLETION-ITEM-KIND? :INITARG :COMPLETION-ITEM-KIND :DOCUMENTATION "" :TYPE
                        (LEM-LSP-MODE/TYPE:TS-INTERFACE
                         ("valueSet" :TYPE (LEM-LSP-MODE/TYPE:TS-ARRAY COMPLETION-ITEM-KIND) :OPTIONAL-P
                          COMMON-LISP:T))
...
(COMMON-LISP:DEFCLASS COMPLETION-REGISTRATION-OPTIONS (TEXT-DOCUMENT-REGISTRATION-OPTIONS COMPLETION-OPTIONS)
                      COMMON-LISP:NIL)
...
(COMMON-LISP:DEFTYPE COMPLETION-TRIGGER-KIND ()
  '(COMMON-LISP:OR (LEM-LSP-MODE/TYPE:TS-EQUAL-SPECIALIZER 1) (LEM-LSP-MODE/TYPE:TS-EQUAL-SPECIALIZER 2)
                   (LEM-LSP-MODE/TYPE:TS-EQUAL-SPECIALIZER 3)))
...
* insert an unqualified type)."
                        :TYPE (LEM-LSP-MODE/TYPE:TS-ARRAY TEXT-EDIT) :READER
                        COMPLETION-ITEM-ADDITIONAL-TEXT-EDITS)
...
* property. The order describes the preferred format of the client."
                        :TYPE (LEM-LSP-MODE/TYPE:TS-ARRAY MARKUP-KIND) :READER
                        HOVER-CLIENT-CAPABILITIES-CONTENT-FORMAT)))
...
* The hover's content"
                        :TYPE
                        (COMMON-LISP:OR MARKED-STRING (LEM-LSP-MODE/TYPE:TS-ARRAY MARKED-STRING)
                                        MARKUP-CONTENT)
...
* specific properties."
                        ...
                        (LEM-LSP-MODE/TYPE:TS-INTERFACE
                         ...
                         ("parameterInformation" :TYPE
                          (LEM-LSP-MODE/TYPE:TS-INTERFACE
                           ("labelOffsetSupport" :TYPE COMMON-LISP:BOOLEAN :OPTIONAL-P COMMON-LISP:T))
                          :OPTIONAL-P COMMON-LISP:T))
...
* request should return `null`."
                        :TYPE (LEM-LSP-MODE/TYPE:TS-ARRAY SIGNATURE-INFORMATION) :READER
                        SIGNATURE-HELP-SIGNATURES)
...
* The parameters of this signature."
                        :TYPE (LEM-LSP-MODE/TYPE:TS-ARRAY PARAMETER-INFORMATION) :READER
                        SIGNATURE-INFORMATION-PARAMETERS)))
...
* Its intended use case is to highlight the parameter label part in the `SignatureInformation.label`."
                        :TYPE
                        (COMMON-LISP:OR COMMON-LISP:STRING
                                        (LEM-LSP-MODE/TYPE:TS-TUPLE COMMON-LISP:NUMBER COMMON-LISP:NUMBER))
...
(COMMON-LISP:DEFCLASS DEFINITION-REGISTRATION-OPTIONS (TEXT-DOCUMENT-REGISTRATION-OPTIONS DEFINITION-OPTIONS)
                      COMMON-LISP:NIL)
...
(COMMON-LISP:DEFCLASS REFERENCE-REGISTRATION-OPTIONS (TEXT-DOCUMENT-REGISTRATION-OPTIONS REFERENCE-OPTIONS)
                      COMMON-LISP:NIL)
...
* Specific capabilities for the `SymbolKind` in the `textDocument/documentSymbol` request."
                       ...
                       (HIERARCHICAL-DOCUMENT-SYMBOL-SUPPORT? :INITARG :HIERARCHICAL-DOCUMENT-SYMBOL-SUPPORT
                        :DOCUMENTATION "*
...
* @since 3.8.0"
                        ...
                        (LEM-LSP-MODE/TYPE:TS-INTERFACE
                         ("codeActionKind" :TYPE
                          (LEM-LSP-MODE/TYPE:TS-INTERFACE
                           ("valueSet" :TYPE (LEM-LSP-MODE/TYPE:TS-ARRAY CODE-ACTION-KIND) :OPTIONAL-P
                            COMMON-LISP:NIL))
                          :OPTIONAL-P COMMON-LISP:NIL))
...
* may list out every specific kind they provide."
                        :TYPE (LEM-LSP-MODE/TYPE:TS-ARRAY CODE-ACTION-KIND) :READER
                        CODE-ACTION-OPTIONS-CODE-ACTION-KINDS)))
...
(COMMON-LISP:DEFCLASS CODE-LENS-REGISTRATION-OPTIONS (TEXT-DOCUMENT-REGISTRATION-OPTIONS CODE-LENS-OPTIONS)
                      COMMON-LISP:NIL)
...
(COMMON-LISP:DEFCLASS DOCUMENT-COLOR-REGISTRATION-OPTIONS
                      (TEXT-DOCUMENT-REGISTRATION-OPTIONS STATIC-REGISTRATION-OPTIONS DOCUMENT-COLOR-OPTIONS)
                      COMMON-LISP:NIL)
...
(COMMON-LISP:DEFCLASS DOCUMENT-FORMATTING-REGISTRATION-OPTIONS
                      (TEXT-DOCUMENT-REGISTRATION-OPTIONS DOCUMENT-FORMATTING-OPTIONS) COMMON-LISP:NIL)
...
(COMMON-LISP:DEFCLASS DOCUMENT-RANGE-FORMATTING-REGISTRATION-OPTIONS
                      (TEXT-DOCUMENT-REGISTRATION-OPTIONS DOCUMENT-RANGE-FORMATTING-OPTIONS) COMMON-LISP:NIL)
...
(COMMON-LISP:DEFCLASS DOCUMENT-ON-TYPE-FORMATTING-REGISTRATION-OPTIONS
                      (TEXT-DOCUMENT-REGISTRATION-OPTIONS DOCUMENT-ON-TYPE-FORMATTING-OPTIONS) COMMON-LISP:NIL)
