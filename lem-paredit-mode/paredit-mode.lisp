...
(defun self-insertable ()
  "dirty hack"
  (lem::disable-minor-mode 'paredit-mode)
  (prog1
      (eql (lem::lookup-keybind (lem::parse-keyspec "("))
           'self-insert)
    (lem::enable-minor-mode 'paredit-mode)))

(define-command paredit-insert-paren () ()
  (when (self-insertable)
    (let ((p (current-point)))
