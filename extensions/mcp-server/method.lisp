...
(defgeneric call-mcp-method (method params)
  (:documentation "Call an MCP method with the given params."))

(defgeneric call-mcp-method-aux (method params)
...
(defmethod call-mcp-method ((method mcp-method) params)
  "Default implementation of call-mcp-method."
  (log-mcp-request (mcp-method-name method) params)
  (with-error-handler ()
    (let ((response (call-mcp-method-aux method params)))
    ...
    `(progn
       ...
       (defclass ,class-name (mcp-method)
         ...
         (:default-initargs
          :name ,method-name
          :params-type nil))
       (defmethod call-mcp-method-aux ((,instance ,class-name) ,params)
