;;; Code generated by LEM-LSP-MODE/PROTOCOL-GENERATOR based on specification-3-15.md; DO NOT EDIT.
...
(cl-package-locks:lock-package :lem-lsp-mode/protocol)
(COMMON-LISP:DEFCLASS MESSAGE (LEM-LSP-MODE/JSON:OBJECT) ((JSONRPC :INITARG :JSONRPC :DOCUMENTATION "" :TYPE COMMON-LISP:STRING :READER MESSAGE-JSONRPC)))

(COMMON-LISP:DEFCLASS REQUEST-MESSAGE (MESSAGE)
                      ((ID :INITARG :ID :DOCUMENTATION "*
* The request id."
                        :TYPE (COMMON-LISP:OR COMMON-LISP:NUMBER COMMON-LISP:STRING) :READER REQUEST-MESSAGE-ID)
...
(COMMON-LISP:DEFCLASS RESPONSE-MESSAGE (MESSAGE)
                      ((ID :INITARG :ID :DOCUMENTATION "*
* The request id."
                        :TYPE (COMMON-LISP:OR COMMON-LISP:NUMBER COMMON-LISP:STRING NULL) :READER RESPONSE-MESSAGE-ID)
                       (RESULT? :INITARG :RESULT :DOCUMENTATION "*
* The result of a request. This member is REQUIRED on success.
* This member MUST NOT exist if there was an error invoking the method."
                        :TYPE (COMMON-LISP:OR COMMON-LISP:STRING COMMON-LISP:NUMBER COMMON-LISP:BOOLEAN OBJECT NULL) :READER RESPONSE-MESSAGE-RESULT)
                       (ERROR? :INITARG :ERROR :DOCUMENTATION "*
* The error object in case a request fails."
                        :TYPE RESPONSE-ERROR :READER RESPONSE-MESSAGE-ERROR)))

(COMMON-LISP:DEFCLASS RESPONSE-ERROR (LEM-LSP-MODE/JSON:OBJECT)
...
* information about the error. Can be omitted."
                        :TYPE (COMMON-LISP:OR COMMON-LISP:STRING COMMON-LISP:NUMBER COMMON-LISP:BOOLEAN ARRAY OBJECT NULL) :READER RESPONSE-ERROR-DATA)))
...
(COMMON-LISP:DEFCLASS CANCEL-PARAMS (LEM-LSP-MODE/JSON:OBJECT)
                      ((ID :INITARG :ID :DOCUMENTATION "*
* The request id to cancel."
                        :TYPE (COMMON-LISP:OR COMMON-LISP:NUMBER COMMON-LISP:STRING) :READER CANCEL-PARAMS-ID)))

(COMMON-LISP:DEFTYPE PROGRESS-TOKEN () '(COMMON-LISP:OR COMMON-LISP:NUMBER COMMON-LISP:STRING))

(COMMON-LISP:DEFCLASS PROGRESS-PARAMS (LEM-LSP-MODE/JSON:OBJECT)
...
(COMMON-LISP:DEFCLASS POSITION (LEM-LSP-MODE/JSON:OBJECT)
...
(COMMON-LISP:DEFCLASS RANGE (LEM-LSP-MODE/JSON:OBJECT)
...
(COMMON-LISP:DEFCLASS LOCATION (LEM-LSP-MODE/JSON:OBJECT)
                      ((URI :INITARG :URI :DOCUMENTATION "" :TYPE DOCUMENT-URI :READER LOCATION-URI) (RANGE :INITARG :RANGE :DOCUMENTATION "" :TYPE RANGE :READER LOCATION-RANGE)))

(COMMON-LISP:DEFCLASS LOCATION-LINK (LEM-LSP-MODE/JSON:OBJECT)
...
(COMMON-LISP:DEFCLASS DIAGNOSTIC (LEM-LSP-MODE/JSON:OBJECT)
...
* The diagnostic's code, which might appear in the user interface."
                        :TYPE (COMMON-LISP:OR COMMON-LISP:NUMBER COMMON-LISP:STRING) :READER DIAGNOSTIC-CODE)
...
*
* @since 3.15.0"
                        :TYPE (LEM-LSP-MODE/TYPE:TS-ARRAY DIAGNOSTIC-TAG) :READER DIAGNOSTIC-TAGS)
                       (RELATED-INFORMATION? :INITARG :RELATED-INFORMATION :DOCUMENTATION "*
* An array of related diagnostic information, e.g. when symbol-names within
* a scope collide all definitions can be marked via this property."
                        :TYPE (LEM-LSP-MODE/TYPE:TS-ARRAY DIAGNOSTIC-RELATED-INFORMATION) :READER DIAGNOSTIC-RELATED-INFORMATION)))
...
(COMMON-LISP:DEFTYPE DIAGNOSTIC-SEVERITY ()
  '(COMMON-LISP:OR (LEM-LSP-MODE/TYPE:TS-EQUAL-SPECIALIZER 1) (LEM-LSP-MODE/TYPE:TS-EQUAL-SPECIALIZER 2) (LEM-LSP-MODE/TYPE:TS-EQUAL-SPECIALIZER 3)
                   (LEM-LSP-MODE/TYPE:TS-EQUAL-SPECIALIZER 4)))
...
(COMMON-LISP:DEFTYPE DIAGNOSTIC-TAG () '(COMMON-LISP:OR (LEM-LSP-MODE/TYPE:TS-EQUAL-SPECIALIZER 1) (LEM-LSP-MODE/TYPE:TS-EQUAL-SPECIALIZER 2)))

(COMMON-LISP:DEFCLASS DIAGNOSTIC-RELATED-INFORMATION (LEM-LSP-MODE/JSON:OBJECT)
...
(COMMON-LISP:DEFCLASS COMMAND (LEM-LSP-MODE/JSON:OBJECT)
...
* invoked with."
                        :TYPE (LEM-LSP-MODE/TYPE:TS-ARRAY COMMON-LISP:T) :READER COMMAND-ARGUMENTS)))

(COMMON-LISP:DEFCLASS TEXT-EDIT (LEM-LSP-MODE/JSON:OBJECT)
                      ((RANGE :INITARG :RANGE :DOCUMENTATION "*
...
(COMMON-LISP:DEFCLASS TEXT-DOCUMENT-EDIT (LEM-LSP-MODE/JSON:OBJECT)
                      ((TEXT-DOCUMENT :INITARG :TEXT-DOCUMENT :DOCUMENTATION "*
* The text document to change."
                        :TYPE VERSIONED-TEXT-DOCUMENT-IDENTIFIER :READER TEXT-DOCUMENT-EDIT-TEXT-DOCUMENT)
                       (EDITS :INITARG :EDITS :DOCUMENTATION "*
* The edits to be applied."
                        :TYPE (LEM-LSP-MODE/TYPE:TS-ARRAY TEXT-EDIT) :READER TEXT-DOCUMENT-EDIT-EDITS)))

(COMMON-LISP:DEFCLASS CREATE-FILE-OPTIONS (LEM-LSP-MODE/JSON:OBJECT)
...
(COMMON-LISP:DEFCLASS CREATE-FILE (LEM-LSP-MODE/JSON:OBJECT)
                      ((KIND :INITARG :KIND :DOCUMENTATION "*
* A create"
                        :TYPE (LEM-LSP-MODE/TYPE:TS-EQUAL-SPECIALIZER "create") :READER CREATE-FILE-KIND)
...
(COMMON-LISP:DEFCLASS RENAME-FILE-OPTIONS (LEM-LSP-MODE/JSON:OBJECT)
                      ((OVERWRITE? :INITARG :OVERWRITE :DOCUMENTATION "*
...
(COMMON-LISP:DEFCLASS RENAME-FILE (LEM-LSP-MODE/JSON:OBJECT)
                      ((KIND :INITARG :KIND :DOCUMENTATION "*
* A rename"
                        :TYPE (LEM-LSP-MODE/TYPE:TS-EQUAL-SPECIALIZER "rename") :READER RENAME-FILE-KIND)
...
(COMMON-LISP:DEFCLASS DELETE-FILE-OPTIONS (LEM-LSP-MODE/JSON:OBJECT)
...
(COMMON-LISP:DEFCLASS DELETE-FILE (LEM-LSP-MODE/JSON:OBJECT)
                      ((KIND :INITARG :KIND :DOCUMENTATION "*
* A delete"
                        :TYPE (LEM-LSP-MODE/TYPE:TS-EQUAL-SPECIALIZER "delete") :READER DELETE-FILE-KIND)
                       (URI :INITARG :URI :DOCUMENTATION "*
* The file to delete."
...
(COMMON-LISP:DEFCLASS WORKSPACE-EDIT (LEM-LSP-MODE/JSON:OBJECT)
                      ((CHANGES? :INITARG :CHANGES :DOCUMENTATION "*
* Holds changes to existing resources."
                        :TYPE
                        (LEM-LSP-MODE/TYPE:TS-INTERFACE ("uri" :TYPE (LEM-LSP-MODE/TYPE:TS-OBJECT DOCUMENT-URI (LEM-LSP-MODE/TYPE:TS-ARRAY TEXT-EDIT)) :OPTIONAL-P COMMON-LISP:NIL))
...
* only plain `TextEdit`s using the `changes` property are supported."
                        :TYPE
                        (COMMON-LISP:OR (LEM-LSP-MODE/TYPE:TS-ARRAY TEXT-DOCUMENT-EDIT)
                                        (LEM-LSP-MODE/TYPE:TS-ARRAY (COMMON-LISP:OR TEXT-DOCUMENT-EDIT CREATE-FILE RENAME-FILE DELETE-FILE)))
                        :READER WORKSPACE-EDIT-DOCUMENT-CHANGES)))

(COMMON-LISP:DEFCLASS WORKSPACE-EDIT-CLIENT-CAPABILITIES (LEM-LSP-MODE/JSON:OBJECT)
                      ((DOCUMENT-CHANGES? :INITARG :DOCUMENT-CHANGES :DOCUMENTATION "*
* The client supports versioned document changes in `WorkspaceEdit`s"
                        :TYPE COMMON-LISP:BOOLEAN :READER WORKSPACE-EDIT-CLIENT-CAPABILITIES-DOCUMENT-CHANGES)
                       (RESOURCE-OPERATIONS? :INITARG :RESOURCE-OPERATIONS :DOCUMENTATION "*
* The resource operations the client supports. Clients should at least
* support 'create', 'rename' and 'delete' files and folders.
*
* @since 3.13.0"
                        :TYPE (LEM-LSP-MODE/TYPE:TS-ARRAY RESOURCE-OPERATION-KIND) :READER WORKSPACE-EDIT-CLIENT-CAPABILITIES-RESOURCE-OPERATIONS)
                       (FAILURE-HANDLING? :INITARG :FAILURE-HANDLING :DOCUMENTATION "*
* The failure handling strategy of a client if applying the workspace edit
* fails.
*
* @since 3.13.0"
                        :TYPE FAILURE-HANDLING-KIND :READER WORKSPACE-EDIT-CLIENT-CAPABILITIES-FAILURE-HANDLING)))

(COMMON-LISP:DEFTYPE RESOURCE-OPERATION-KIND ()
  '(COMMON-LISP:OR (LEM-LSP-MODE/TYPE:TS-EQUAL-SPECIALIZER "create") (LEM-LSP-MODE/TYPE:TS-EQUAL-SPECIALIZER "rename") (LEM-LSP-MODE/TYPE:TS-EQUAL-SPECIALIZER "delete")))
...
(COMMON-LISP:DEFTYPE FAILURE-HANDLING-KIND ()
  '(COMMON-LISP:OR (LEM-LSP-MODE/TYPE:TS-EQUAL-SPECIALIZER "abort") (LEM-LSP-MODE/TYPE:TS-EQUAL-SPECIALIZER "transactional") (LEM-LSP-MODE/TYPE:TS-EQUAL-SPECIALIZER "undo")
                   (LEM-LSP-MODE/TYPE:TS-EQUAL-SPECIALIZER "textOnlyTransactional")))
...
(COMMON-LISP:DEFCLASS TEXT-DOCUMENT-IDENTIFIER (LEM-LSP-MODE/JSON:OBJECT)
                      ((URI :INITARG :URI :DOCUMENTATION "*
* The text document's URI."
                        :TYPE DOCUMENT-URI :READER TEXT-DOCUMENT-IDENTIFIER-URI)))

(COMMON-LISP:DEFCLASS TEXT-DOCUMENT-ITEM (LEM-LSP-MODE/JSON:OBJECT)
                      ((URI :INITARG :URI :DOCUMENTATION "*
* The text document's URI."
...
* undo/redo. The number doesn't need to be consecutive."
                        :TYPE (COMMON-LISP:OR COMMON-LISP:NUMBER NULL) :READER VERSIONED-TEXT-DOCUMENT-IDENTIFIER-VERSION)))

(COMMON-LISP:DEFCLASS TEXT-DOCUMENT-POSITION-PARAMS (LEM-LSP-MODE/JSON:OBJECT)
                      ((TEXT-DOCUMENT :INITARG :TEXT-DOCUMENT :DOCUMENTATION "*
* The text document."
                        :TYPE TEXT-DOCUMENT-IDENTIFIER :READER TEXT-DOCUMENT-POSITION-PARAMS-TEXT-DOCUMENT)
                       (POSITION :INITARG :POSITION :DOCUMENTATION "*
* The position inside the text document."
                        :TYPE POSITION :READER TEXT-DOCUMENT-POSITION-PARAMS-POSITION)))

(COMMON-LISP:DEFCLASS DOCUMENT-FILTER (LEM-LSP-MODE/JSON:OBJECT)
...
(COMMON-LISP:DEFTYPE DOCUMENT-SELECTOR () '(LEM-LSP-MODE/TYPE:TS-ARRAY DOCUMENT-FILTER))

(COMMON-LISP:DEFCLASS STATIC-REGISTRATION-OPTIONS (LEM-LSP-MODE/JSON:OBJECT)
                      ((ID? :INITARG :ID :DOCUMENTATION "*
* The id used to register the request. The id can be used to deregister
* the request again. See also Registration#id."
                        :TYPE COMMON-LISP:STRING :READER STATIC-REGISTRATION-OPTIONS-ID)))

(COMMON-LISP:DEFCLASS TEXT-DOCUMENT-REGISTRATION-OPTIONS (LEM-LSP-MODE/JSON:OBJECT)
                      ((DOCUMENT-SELECTOR :INITARG :DOCUMENT-SELECTOR :DOCUMENTATION "*
* A document selector to identify the scope of the registration. If set to null
* the document selector provided on the client side will be used."
                        :TYPE (COMMON-LISP:OR DOCUMENT-SELECTOR NULL) :READER TEXT-DOCUMENT-REGISTRATION-OPTIONS-DOCUMENT-SELECTOR)))
...
(COMMON-LISP:DEFTYPE MARKUP-KIND () '(COMMON-LISP:OR (LEM-LSP-MODE/TYPE:TS-EQUAL-SPECIALIZER "plaintext") (LEM-LSP-MODE/TYPE:TS-EQUAL-SPECIALIZER "markdown")))

(COMMON-LISP:DEFCLASS MARKUP-CONTENT (LEM-LSP-MODE/JSON:OBJECT)
                      ((KIND :INITARG :KIND :DOCUMENTATION "*
...
(COMMON-LISP:DEFCLASS WORK-DONE-PROGRESS-BEGIN (LEM-LSP-MODE/JSON:OBJECT)
                      ((KIND :INITARG :KIND :DOCUMENTATION "" :TYPE (LEM-LSP-MODE/TYPE:TS-EQUAL-SPECIALIZER "begin") :READER WORK-DONE-PROGRESS-BEGIN-KIND)
                       (TITLE :INITARG :TITLE :DOCUMENTATION "*
...
(COMMON-LISP:DEFCLASS WORK-DONE-PROGRESS-REPORT (LEM-LSP-MODE/JSON:OBJECT)
                      ((KIND :INITARG :KIND :DOCUMENTATION "" :TYPE (LEM-LSP-MODE/TYPE:TS-EQUAL-SPECIALIZER "report") :READER WORK-DONE-PROGRESS-REPORT-KIND)
                       (CANCELLABLE? :INITARG :CANCELLABLE :DOCUMENTATION "*
...
(COMMON-LISP:DEFCLASS WORK-DONE-PROGRESS-END (LEM-LSP-MODE/JSON:OBJECT)
                      ((KIND :INITARG :KIND :DOCUMENTATION "" :TYPE (LEM-LSP-MODE/TYPE:TS-EQUAL-SPECIALIZER "end") :READER WORK-DONE-PROGRESS-END-KIND)
                       (MESSAGE? :INITARG :MESSAGE :DOCUMENTATION "*
* Optional, a final message indicating to for example indicate the outcome
* of the operation."
                        :TYPE COMMON-LISP:STRING :READER WORK-DONE-PROGRESS-END-MESSAGE)))

(COMMON-LISP:DEFCLASS WORK-DONE-PROGRESS-PARAMS (LEM-LSP-MODE/JSON:OBJECT)
...
(COMMON-LISP:DEFCLASS WORK-DONE-PROGRESS-OPTIONS (LEM-LSP-MODE/JSON:OBJECT)
                      ((WORK-DONE-PROGRESS? :INITARG :WORK-DONE-PROGRESS :DOCUMENTATION "" :TYPE COMMON-LISP:BOOLEAN :READER WORK-DONE-PROGRESS-OPTIONS-WORK-DONE-PROGRESS)))

(COMMON-LISP:DEFCLASS PARTIAL-RESULT-PARAMS (LEM-LSP-MODE/JSON:OBJECT)
...
* If the parent process is not alive then the server should exit (see exit notification) its process."
                        :TYPE (COMMON-LISP:OR COMMON-LISP:NUMBER NULL) :READER INITIALIZE-PARAMS-PROCESS-ID)
                       (CLIENT-INFO? :INITARG :CLIENT-INFO :DOCUMENTATION "*
* Information about the client
*
* @since 3.15.0"
                        :TYPE
                        (LEM-LSP-MODE/TYPE:TS-INTERFACE ("name" :TYPE COMMON-LISP:STRING :OPTIONAL-P COMMON-LISP:NIL) ("version" :TYPE COMMON-LISP:STRING :OPTIONAL-P COMMON-LISP:T))
...
* @deprecated in favour of rootUri."
                        :TYPE (COMMON-LISP:OR COMMON-LISP:STRING NULL) :READER INITIALIZE-PARAMS-ROOT-PATH)
                       (ROOT-URI :INITARG :ROOT-URI :DOCUMENTATION "*
* The rootUri of the workspace. Is null if no
* folder is open. If both `rootPath` and `rootUri` are set
* `rootUri` wins."
                        :TYPE (COMMON-LISP:OR DOCUMENT-URI NULL) :READER INITIALIZE-PARAMS-ROOT-URI)
...
* The initial trace setting. If omitted trace is disabled ('off')."
                        :TYPE
                        (COMMON-LISP:OR (LEM-LSP-MODE/TYPE:TS-EQUAL-SPECIALIZER "off") (LEM-LSP-MODE/TYPE:TS-EQUAL-SPECIALIZER "messages")
                                        (LEM-LSP-MODE/TYPE:TS-EQUAL-SPECIALIZER "verbose"))
...
*
* @since 3.6.0"
                        :TYPE (COMMON-LISP:OR (LEM-LSP-MODE/TYPE:TS-ARRAY WORKSPACE-FOLDER) NULL) :READER INITIALIZE-PARAMS-WORKSPACE-FOLDERS)))

(COMMON-LISP:DEFCLASS TEXT-DOCUMENT-CLIENT-CAPABILITIES (LEM-LSP-MODE/JSON:OBJECT)
                      ((SYNCHRONIZATION? :INITARG :SYNCHRONIZATION :DOCUMENTATION "" :TYPE TEXT-DOCUMENT-SYNC-CLIENT-CAPABILITIES :READER
                        TEXT-DOCUMENT-CLIENT-CAPABILITIES-SYNCHRONIZATION)
                       (COMPLETION? :INITARG :COMPLETION :DOCUMENTATION "*
* Capabilities specific to the `textDocument/completion` request."
                        :TYPE COMPLETION-CLIENT-CAPABILITIES :READER TEXT-DOCUMENT-CLIENT-CAPABILITIES-COMPLETION)
                       (HOVER? :INITARG :HOVER :DOCUMENTATION "*
* Capabilities specific to the `textDocument/hover` request."
                        :TYPE HOVER-CLIENT-CAPABILITIES :READER TEXT-DOCUMENT-CLIENT-CAPABILITIES-HOVER)
                       (SIGNATURE-HELP? :INITARG :SIGNATURE-HELP :DOCUMENTATION "*
* Capabilities specific to the `textDocument/signatureHelp` request."
                        :TYPE SIGNATURE-HELP-CLIENT-CAPABILITIES :READER TEXT-DOCUMENT-CLIENT-CAPABILITIES-SIGNATURE-HELP)
                       (DECLARATION? :INITARG :DECLARATION :DOCUMENTATION "*
* Capabilities specific to the `textDocument/declaration` request.
*
* @since 3.14.0"
                        :TYPE DECLARATION-CLIENT-CAPABILITIES :READER TEXT-DOCUMENT-CLIENT-CAPABILITIES-DECLARATION)
                       (DEFINITION? :INITARG :DEFINITION :DOCUMENTATION "*
* Capabilities specific to the `textDocument/definition` request."
                        :TYPE DEFINITION-CLIENT-CAPABILITIES :READER TEXT-DOCUMENT-CLIENT-CAPABILITIES-DEFINITION)
                       (TYPE-DEFINITION? :INITARG :TYPE-DEFINITION :DOCUMENTATION "*
* Capabilities specific to the `textDocument/typeDefinition` request.
*
* @since 3.6.0"
                        :TYPE TYPE-DEFINITION-CLIENT-CAPABILITIES :READER TEXT-DOCUMENT-CLIENT-CAPABILITIES-TYPE-DEFINITION)
                       (IMPLEMENTATION? :INITARG :IMPLEMENTATION :DOCUMENTATION "*
* Capabilities specific to the `textDocument/implementation` request.
*
* @since 3.6.0"
                        :TYPE IMPLEMENTATION-CLIENT-CAPABILITIES :READER TEXT-DOCUMENT-CLIENT-CAPABILITIES-IMPLEMENTATION)
                       (REFERENCES? :INITARG :REFERENCES :DOCUMENTATION "*
* Capabilities specific to the `textDocument/references` request."
                        :TYPE REFERENCE-CLIENT-CAPABILITIES :READER TEXT-DOCUMENT-CLIENT-CAPABILITIES-REFERENCES)
                       (DOCUMENT-HIGHLIGHT? :INITARG :DOCUMENT-HIGHLIGHT :DOCUMENTATION "*
* Capabilities specific to the `textDocument/documentHighlight` request."
                        :TYPE DOCUMENT-HIGHLIGHT-CLIENT-CAPABILITIES :READER TEXT-DOCUMENT-CLIENT-CAPABILITIES-DOCUMENT-HIGHLIGHT)
                       (DOCUMENT-SYMBOL? :INITARG :DOCUMENT-SYMBOL :DOCUMENTATION "*
* Capabilities specific to the `textDocument/documentSymbol` request."
                        :TYPE DOCUMENT-SYMBOL-CLIENT-CAPABILITIES :READER TEXT-DOCUMENT-CLIENT-CAPABILITIES-DOCUMENT-SYMBOL)
                       (CODE-ACTION? :INITARG :CODE-ACTION :DOCUMENTATION "*
* Capabilities specific to the `textDocument/codeAction` request."
                        :TYPE CODE-ACTION-CLIENT-CAPABILITIES :READER TEXT-DOCUMENT-CLIENT-CAPABILITIES-CODE-ACTION)
                       (CODE-LENS? :INITARG :CODE-LENS :DOCUMENTATION "*
* Capabilities specific to the `textDocument/codeLens` request."
                        :TYPE CODE-LENS-CLIENT-CAPABILITIES :READER TEXT-DOCUMENT-CLIENT-CAPABILITIES-CODE-LENS)
                       (DOCUMENT-LINK? :INITARG :DOCUMENT-LINK :DOCUMENTATION "*
* Capabilities specific to the `textDocument/documentLink` request."
                        :TYPE DOCUMENT-LINK-CLIENT-CAPABILITIES :READER TEXT-DOCUMENT-CLIENT-CAPABILITIES-DOCUMENT-LINK)
                       (COLOR-PROVIDER? :INITARG :COLOR-PROVIDER :DOCUMENTATION "*
* Capabilities specific to the `textDocument/documentColor` and the
* `textDocument/colorPresentation` request.
*
* @since 3.6.0"
                        :TYPE DOCUMENT-COLOR-CLIENT-CAPABILITIES :READER TEXT-DOCUMENT-CLIENT-CAPABILITIES-COLOR-PROVIDER)
                       (FORMATTING? :INITARG :FORMATTING :DOCUMENTATION "*
* Capabilities specific to the `textDocument/formatting` request."
                        :TYPE DOCUMENT-FORMATTING-CLIENT-CAPABILITIES :READER TEXT-DOCUMENT-CLIENT-CAPABILITIES-FORMATTING)
                       (RANGE-FORMATTING? :INITARG :RANGE-FORMATTING :DOCUMENTATION "*
* Capabilities specific to the `textDocument/rangeFormatting` request."
                        :TYPE DOCUMENT-RANGE-FORMATTING-CLIENT-CAPABILITIES :READER TEXT-DOCUMENT-CLIENT-CAPABILITIES-RANGE-FORMATTING)
                       (ON-TYPE-FORMATTING? :INITARG :ON-TYPE-FORMATTING :DOCUMENTATION "* request.
* Capabilities specific to the `textDocument/onTypeFormatting` request."
                        :TYPE DOCUMENT-ON-TYPE-FORMATTING-CLIENT-CAPABILITIES :READER TEXT-DOCUMENT-CLIENT-CAPABILITIES-ON-TYPE-FORMATTING)
                       (RENAME? :INITARG :RENAME :DOCUMENTATION "*
* Capabilities specific to the `textDocument/rename` request."
                        :TYPE RENAME-CLIENT-CAPABILITIES :READER TEXT-DOCUMENT-CLIENT-CAPABILITIES-RENAME)
                       (PUBLISH-DIAGNOSTICS? :INITARG :PUBLISH-DIAGNOSTICS :DOCUMENTATION "*
* Capabilities specific to the `textDocument/publishDiagnostics` notification."
                        :TYPE PUBLISH-DIAGNOSTICS-CLIENT-CAPABILITIES :READER TEXT-DOCUMENT-CLIENT-CAPABILITIES-PUBLISH-DIAGNOSTICS)
                       (FOLDING-RANGE? :INITARG :FOLDING-RANGE :DOCUMENTATION "*
* Capabilities specific to the `textDocument/foldingRange` request.
*
* @since 3.10.0"
                        :TYPE FOLDING-RANGE-CLIENT-CAPABILITIES :READER TEXT-DOCUMENT-CLIENT-CAPABILITIES-FOLDING-RANGE)
                       (SELECTION-RANGE? :INITARG :SELECTION-RANGE :DOCUMENTATION "*
* Capabilities specific to the `textDocument/selectionRange` request.
*
* @since 3.15.0"
                        :TYPE SELECTION-RANGE-CLIENT-CAPABILITIES :READER TEXT-DOCUMENT-CLIENT-CAPABILITIES-SELECTION-RANGE)))

(COMMON-LISP:DEFCLASS CLIENT-CAPABILITIES (LEM-LSP-MODE/JSON:OBJECT)
...
* Workspace specific client capabilities."
                        ...
                        (LEM-LSP-MODE/TYPE:TS-INTERFACE ("applyEdit" :TYPE COMMON-LISP:BOOLEAN :OPTIONAL-P COMMON-LISP:T)
                         ...
                         ("workspaceFolders" :TYPE COMMON-LISP:BOOLEAN :OPTIONAL-P COMMON-LISP:T) ("configuration" :TYPE COMMON-LISP:BOOLEAN :OPTIONAL-P COMMON-LISP:T))
...
* Window specific client capabilities."
                        :TYPE (LEM-LSP-MODE/TYPE:TS-INTERFACE ("workDoneProgress" :TYPE COMMON-LISP:BOOLEAN :OPTIONAL-P COMMON-LISP:T)) :READER CLIENT-CAPABILITIES-WINDOW)
                       (EXPERIMENTAL? :INITARG :EXPERIMENTAL :DOCUMENTATION "*
* Experimental client capabilities."
                        :TYPE COMMON-LISP:T :READER CLIENT-CAPABILITIES-EXPERIMENTAL)))

(COMMON-LISP:DEFCLASS INITIALIZE-RESULT (LEM-LSP-MODE/JSON:OBJECT)
                      ((CAPABILITIES :INITARG :CAPABILITIES :DOCUMENTATION "*
...
(COMMON-LISP:DEFCLASS INITIALIZE-ERROR (LEM-LSP-MODE/JSON:OBJECT)
...
(COMMON-LISP:DEFCLASS SERVER-CAPABILITIES (LEM-LSP-MODE/JSON:OBJECT)
                      ((TEXT-DOCUMENT-SYNC? :INITARG :TEXT-DOCUMENT-SYNC :DOCUMENTATION "*
* Defines how text documents are synced. Is either a detailed structure defining each notification or
* for backwards compatibility the TextDocumentSyncKind number. If omitted it defaults to `TextDocumentSyncKind.None`."
                        :TYPE (COMMON-LISP:OR TEXT-DOCUMENT-SYNC-OPTIONS COMMON-LISP:NUMBER) :READER SERVER-CAPABILITIES-TEXT-DOCUMENT-SYNC)
...
* The server provides hover support."
                        :TYPE (COMMON-LISP:OR COMMON-LISP:BOOLEAN HOVER-OPTIONS) :READER SERVER-CAPABILITIES-HOVER-PROVIDER)
                       (SIGNATURE-HELP-PROVIDER? :INITARG :SIGNATURE-HELP-PROVIDER :DOCUMENTATION "*
* The server provides signature help support."
                        :TYPE SIGNATURE-HELP-OPTIONS :READER SERVER-CAPABILITIES-SIGNATURE-HELP-PROVIDER)
                       (DECLARATION-PROVIDER? :INITARG :DECLARATION-PROVIDER :DOCUMENTATION "*
* The server provides go to declaration support.
*
* @since 3.14.0"
                        :TYPE (COMMON-LISP:OR COMMON-LISP:BOOLEAN DECLARATION-OPTIONS DECLARATION-REGISTRATION-OPTIONS) :READER SERVER-CAPABILITIES-DECLARATION-PROVIDER)
                       (DEFINITION-PROVIDER? :INITARG :DEFINITION-PROVIDER :DOCUMENTATION "*
* The server provides goto definition support."
                        :TYPE (COMMON-LISP:OR COMMON-LISP:BOOLEAN DEFINITION-OPTIONS) :READER SERVER-CAPABILITIES-DEFINITION-PROVIDER)
                       (TYPE-DEFINITION-PROVIDER? :INITARG :TYPE-DEFINITION-PROVIDER :DOCUMENTATION "*
* The server provides goto type definition support.
*
* @since 3.6.0"
                        :TYPE (COMMON-LISP:OR COMMON-LISP:BOOLEAN TYPE-DEFINITION-OPTIONS TYPE-DEFINITION-REGISTRATION-OPTIONS) :READER SERVER-CAPABILITIES-TYPE-DEFINITION-PROVIDER)
                       (IMPLEMENTATION-PROVIDER? :INITARG :IMPLEMENTATION-PROVIDER :DOCUMENTATION "*
* The server provides goto implementation support.
*
* @since 3.6.0"
                        :TYPE (COMMON-LISP:OR COMMON-LISP:BOOLEAN IMPLEMENTATION-OPTIONS IMPLEMENTATION-REGISTRATION-OPTIONS) :READER SERVER-CAPABILITIES-IMPLEMENTATION-PROVIDER)
                       (REFERENCES-PROVIDER? :INITARG :REFERENCES-PROVIDER :DOCUMENTATION "*
* The server provides find references support."
                        :TYPE (COMMON-LISP:OR COMMON-LISP:BOOLEAN REFERENCE-OPTIONS) :READER SERVER-CAPABILITIES-REFERENCES-PROVIDER)
                       (DOCUMENT-HIGHLIGHT-PROVIDER? :INITARG :DOCUMENT-HIGHLIGHT-PROVIDER :DOCUMENTATION "*
* The server provides document highlight support."
                        :TYPE (COMMON-LISP:OR COMMON-LISP:BOOLEAN DOCUMENT-HIGHLIGHT-OPTIONS) :READER SERVER-CAPABILITIES-DOCUMENT-HIGHLIGHT-PROVIDER)
                       (DOCUMENT-SYMBOL-PROVIDER? :INITARG :DOCUMENT-SYMBOL-PROVIDER :DOCUMENTATION "*
* The server provides document symbol support."
                        :TYPE (COMMON-LISP:OR COMMON-LISP:BOOLEAN DOCUMENT-SYMBOL-OPTIONS) :READER SERVER-CAPABILITIES-DOCUMENT-SYMBOL-PROVIDER)
                       (CODE-ACTION-PROVIDER? :INITARG :CODE-ACTION-PROVIDER :DOCUMENTATION "*
* The server provides code actions. The `CodeActionOptions` return type is only
* valid if the client signals code action literal support via the property
* `textDocument.codeAction.codeActionLiteralSupport`."
                        :TYPE (COMMON-LISP:OR COMMON-LISP:BOOLEAN CODE-ACTION-OPTIONS) :READER SERVER-CAPABILITIES-CODE-ACTION-PROVIDER)
...
* The server provides document link support."
                        :TYPE DOCUMENT-LINK-OPTIONS :READER SERVER-CAPABILITIES-DOCUMENT-LINK-PROVIDER)
                       (COLOR-PROVIDER? :INITARG :COLOR-PROVIDER :DOCUMENTATION "*
* The server provides color provider support.
*
* @since 3.6.0"
                        :TYPE (COMMON-LISP:OR COMMON-LISP:BOOLEAN DOCUMENT-COLOR-OPTIONS DOCUMENT-COLOR-REGISTRATION-OPTIONS) :READER SERVER-CAPABILITIES-COLOR-PROVIDER)
                       (DOCUMENT-FORMATTING-PROVIDER? :INITARG :DOCUMENT-FORMATTING-PROVIDER :DOCUMENTATION "*
* The server provides document formatting."
                        :TYPE (COMMON-LISP:OR COMMON-LISP:BOOLEAN DOCUMENT-FORMATTING-OPTIONS) :READER SERVER-CAPABILITIES-DOCUMENT-FORMATTING-PROVIDER)
                       (DOCUMENT-RANGE-FORMATTING-PROVIDER? :INITARG :DOCUMENT-RANGE-FORMATTING-PROVIDER :DOCUMENTATION "*
* The server provides document range formatting."
                        :TYPE (COMMON-LISP:OR COMMON-LISP:BOOLEAN DOCUMENT-RANGE-FORMATTING-OPTIONS) :READER SERVER-CAPABILITIES-DOCUMENT-RANGE-FORMATTING-PROVIDER)
                       (DOCUMENT-ON-TYPE-FORMATTING-PROVIDER? :INITARG :DOCUMENT-ON-TYPE-FORMATTING-PROVIDER :DOCUMENTATION "*
* The server provides document formatting on typing."
                        :TYPE DOCUMENT-ON-TYPE-FORMATTING-OPTIONS :READER SERVER-CAPABILITIES-DOCUMENT-ON-TYPE-FORMATTING-PROVIDER)
                       (RENAME-PROVIDER? :INITARG :RENAME-PROVIDER :DOCUMENTATION "*
* The server provides rename support. RenameOptions may only be
* specified if the client states that it supports
* `prepareSupport` in its initial `initialize` request."
                        :TYPE (COMMON-LISP:OR COMMON-LISP:BOOLEAN RENAME-OPTIONS) :READER SERVER-CAPABILITIES-RENAME-PROVIDER)
                       (FOLDING-RANGE-PROVIDER? :INITARG :FOLDING-RANGE-PROVIDER :DOCUMENTATION "*
* The server provides folding provider support.
*
* @since 3.10.0"
                        :TYPE (COMMON-LISP:OR COMMON-LISP:BOOLEAN FOLDING-RANGE-OPTIONS FOLDING-RANGE-REGISTRATION-OPTIONS) :READER SERVER-CAPABILITIES-FOLDING-RANGE-PROVIDER)
                       (EXECUTE-COMMAND-PROVIDER? :INITARG :EXECUTE-COMMAND-PROVIDER :DOCUMENTATION "*
* The server provides execute command support."
                        :TYPE EXECUTE-COMMAND-OPTIONS :READER SERVER-CAPABILITIES-EXECUTE-COMMAND-PROVIDER)
                       (SELECTION-RANGE-PROVIDER? :INITARG :SELECTION-RANGE-PROVIDER :DOCUMENTATION "*
* The server provides selection range support.
*
* @since 3.15.0"
                        :TYPE (COMMON-LISP:OR COMMON-LISP:BOOLEAN SELECTION-RANGE-OPTIONS SELECTION-RANGE-REGISTRATION-OPTIONS) :READER SERVER-CAPABILITIES-SELECTION-RANGE-PROVIDER)
...
* Workspace specific server capabilities"
                        :TYPE (LEM-LSP-MODE/TYPE:TS-INTERFACE ("workspaceFolders" :TYPE WORKSPACE-FOLDERS-SERVER-CAPABILITIES :OPTIONAL-P COMMON-LISP:T)) :READER
                        SERVER-CAPABILITIES-WORKSPACE)
                       (EXPERIMENTAL? :INITARG :EXPERIMENTAL :DOCUMENTATION "*
* Experimental server capabilities."
                        :TYPE COMMON-LISP:T :READER SERVER-CAPABILITIES-EXPERIMENTAL)))

(COMMON-LISP:DEFCLASS INITIALIZED-PARAMS (LEM-LSP-MODE/JSON:OBJECT) COMMON-LISP:NIL)

(COMMON-LISP:DEFCLASS SHOW-MESSAGE-PARAMS (LEM-LSP-MODE/JSON:OBJECT)
...
(COMMON-LISP:DEFCLASS SHOW-MESSAGE-REQUEST-PARAMS (LEM-LSP-MODE/JSON:OBJECT)
                      ((TYPE :INITARG :TYPE :DOCUMENTATION "*
* The message type. See {@link MessageType}"
...
* The message action items to present."
                        :TYPE (LEM-LSP-MODE/TYPE:TS-ARRAY MESSAGE-ACTION-ITEM) :READER SHOW-MESSAGE-REQUEST-PARAMS-ACTIONS)))

(COMMON-LISP:DEFCLASS MESSAGE-ACTION-ITEM (LEM-LSP-MODE/JSON:OBJECT)
                      ((TITLE :INITARG :TITLE :DOCUMENTATION "*
* A short title like 'Retry', 'Open Log' etc."
                        :TYPE COMMON-LISP:STRING :READER MESSAGE-ACTION-ITEM-TITLE)))

(COMMON-LISP:DEFCLASS LOG-MESSAGE-PARAMS (LEM-LSP-MODE/JSON:OBJECT)
                      ((TYPE :INITARG :TYPE :DOCUMENTATION "*
* The message type. See {@link MessageType}"
...
(COMMON-LISP:DEFCLASS WORK-DONE-PROGRESS-CREATE-PARAMS (LEM-LSP-MODE/JSON:OBJECT)
                      ((TOKEN :INITARG :TOKEN :DOCUMENTATION "*
* The token to be used to report progress."
                        :TYPE PROGRESS-TOKEN :READER WORK-DONE-PROGRESS-CREATE-PARAMS-TOKEN)))

(COMMON-LISP:DEFCLASS WORK-DONE-PROGRESS-CANCEL-PARAMS (LEM-LSP-MODE/JSON:OBJECT)
                      ((TOKEN :INITARG :TOKEN :DOCUMENTATION "*
* The token to be used to report progress."
                        :TYPE PROGRESS-TOKEN :READER WORK-DONE-PROGRESS-CANCEL-PARAMS-TOKEN)))

(COMMON-LISP:DEFCLASS REGISTRATION (LEM-LSP-MODE/JSON:OBJECT)
                      ((ID :INITARG :ID :DOCUMENTATION "*
* The id used to register the request. The id can be used to deregister
* the request again."
...
(COMMON-LISP:DEFCLASS REGISTRATION-PARAMS (LEM-LSP-MODE/JSON:OBJECT)
                      ((REGISTRATIONS :INITARG :REGISTRATIONS :DOCUMENTATION "" :TYPE (LEM-LSP-MODE/TYPE:TS-ARRAY REGISTRATION) :READER REGISTRATION-PARAMS-REGISTRATIONS)))

(COMMON-LISP:DEFCLASS UNREGISTRATION (LEM-LSP-MODE/JSON:OBJECT)
                      ((ID :INITARG :ID :DOCUMENTATION "*
...
(COMMON-LISP:DEFCLASS UNREGISTRATION-PARAMS (LEM-LSP-MODE/JSON:OBJECT)
 ...
 of the specification."
                        :TYPE (LEM-LSP-MODE/TYPE:TS-ARRAY UNREGISTRATION) :READER UNREGISTRATION-PARAMS-UNREGISTERATIONS)))

(COMMON-LISP:DEFCLASS WORKSPACE-FOLDERS-SERVER-CAPABILITIES (LEM-LSP-MODE/JSON:OBJECT)
                      ((SUPPORTED? :INITARG :SUPPORTED :DOCUMENTATION "*
* The server has support for workspace folders"
                        :TYPE COMMON-LISP:BOOLEAN :READER WORKSPACE-FOLDERS-SERVER-CAPABILITIES-SUPPORTED)
...
* using the `client/unregisterCapability` request."
                        :TYPE (COMMON-LISP:OR COMMON-LISP:STRING COMMON-LISP:BOOLEAN) :READER WORKSPACE-FOLDERS-SERVER-CAPABILITIES-CHANGE-NOTIFICATIONS)))

(COMMON-LISP:DEFCLASS WORKSPACE-FOLDER (LEM-LSP-MODE/JSON:OBJECT)
                      ((URI :INITARG :URI :DOCUMENTATION "*
...
(COMMON-LISP:DEFCLASS DID-CHANGE-WORKSPACE-FOLDERS-PARAMS (LEM-LSP-MODE/JSON:OBJECT)
                      ((EVENT :INITARG :EVENT :DOCUMENTATION "*
* The actual workspace folder change event."
                        :TYPE WORKSPACE-FOLDERS-CHANGE-EVENT :READER DID-CHANGE-WORKSPACE-FOLDERS-PARAMS-EVENT)))

(COMMON-LISP:DEFCLASS WORKSPACE-FOLDERS-CHANGE-EVENT (LEM-LSP-MODE/JSON:OBJECT)
                      ((ADDED :INITARG :ADDED :DOCUMENTATION "*
* The array of added workspace folders"
                        :TYPE (LEM-LSP-MODE/TYPE:TS-ARRAY WORKSPACE-FOLDER) :READER WORKSPACE-FOLDERS-CHANGE-EVENT-ADDED)
                       (REMOVED :INITARG :REMOVED :DOCUMENTATION "*
* The array of the removed workspace folders"
                        :TYPE (LEM-LSP-MODE/TYPE:TS-ARRAY WORKSPACE-FOLDER) :READER WORKSPACE-FOLDERS-CHANGE-EVENT-REMOVED)))

(COMMON-LISP:DEFCLASS DID-CHANGE-CONFIGURATION-CLIENT-CAPABILITIES (LEM-LSP-MODE/JSON:OBJECT)
                      ((DYNAMIC-REGISTRATION? :INITARG :DYNAMIC-REGISTRATION :DOCUMENTATION "*
* Did change configuration notification supports dynamic registration."
                        :TYPE COMMON-LISP:BOOLEAN :READER DID-CHANGE-CONFIGURATION-CLIENT-CAPABILITIES-DYNAMIC-REGISTRATION)))

(COMMON-LISP:DEFCLASS DID-CHANGE-CONFIGURATION-PARAMS (LEM-LSP-MODE/JSON:OBJECT)
                      ((SETTINGS :INITARG :SETTINGS :DOCUMENTATION "*
* The actual changed settings"
                        :TYPE COMMON-LISP:T :READER DID-CHANGE-CONFIGURATION-PARAMS-SETTINGS)))

(COMMON-LISP:DEFCLASS CONFIGURATION-PARAMS (LEM-LSP-MODE/JSON:OBJECT)
                      ((ITEMS :INITARG :ITEMS :DOCUMENTATION "" :TYPE (LEM-LSP-MODE/TYPE:TS-ARRAY CONFIGURATION-ITEM) :READER CONFIGURATION-PARAMS-ITEMS)))

(COMMON-LISP:DEFCLASS CONFIGURATION-ITEM (LEM-LSP-MODE/JSON:OBJECT)
...
(COMMON-LISP:DEFCLASS DID-CHANGE-WATCHED-FILES-CLIENT-CAPABILITIES (LEM-LSP-MODE/JSON:OBJECT)
                      ((DYNAMIC-REGISTRATION? :INITARG :DYNAMIC-REGISTRATION :DOCUMENTATION "*
* Did change watched files notification supports dynamic registration. Please note
* that the current protocol doesn't support static configuration for file changes
* from the server side."
                        :TYPE COMMON-LISP:BOOLEAN :READER DID-CHANGE-WATCHED-FILES-CLIENT-CAPABILITIES-DYNAMIC-REGISTRATION)))

(COMMON-LISP:DEFCLASS DID-CHANGE-WATCHED-FILES-REGISTRATION-OPTIONS (LEM-LSP-MODE/JSON:OBJECT)
                      ((WATCHERS :INITARG :WATCHERS :DOCUMENTATION "*
* The watchers to register."
                        :TYPE (LEM-LSP-MODE/TYPE:TS-ARRAY FILE-SYSTEM-WATCHER) :READER DID-CHANGE-WATCHED-FILES-REGISTRATION-OPTIONS-WATCHERS)))

(COMMON-LISP:DEFCLASS FILE-SYSTEM-WATCHER (LEM-LSP-MODE/JSON:OBJECT)
...
(COMMON-LISP:DEFCLASS DID-CHANGE-WATCHED-FILES-PARAMS (LEM-LSP-MODE/JSON:OBJECT)
                      ((CHANGES :INITARG :CHANGES :DOCUMENTATION "*
* The actual file events."
                        :TYPE (LEM-LSP-MODE/TYPE:TS-ARRAY FILE-EVENT) :READER DID-CHANGE-WATCHED-FILES-PARAMS-CHANGES)))

(COMMON-LISP:DEFCLASS FILE-EVENT (LEM-LSP-MODE/JSON:OBJECT)
                      ((URI :INITARG :URI :DOCUMENTATION "*
* The file's URI."
...
(COMMON-LISP:DEFCLASS WORKSPACE-SYMBOL-CLIENT-CAPABILITIES (LEM-LSP-MODE/JSON:OBJECT)
                      ((DYNAMIC-REGISTRATION? :INITARG :DYNAMIC-REGISTRATION :DOCUMENTATION "*
...
* Specific capabilities for the `SymbolKind` in the `workspace/symbol` request."
                        :TYPE (LEM-LSP-MODE/TYPE:TS-INTERFACE ("valueSet" :TYPE (LEM-LSP-MODE/TYPE:TS-ARRAY SYMBOL-KIND) :OPTIONAL-P COMMON-LISP:T)) :READER
                        WORKSPACE-SYMBOL-CLIENT-CAPABILITIES-SYMBOL-KIND)))
...
(COMMON-LISP:DEFCLASS EXECUTE-COMMAND-CLIENT-CAPABILITIES (LEM-LSP-MODE/JSON:OBJECT)
                      ((DYNAMIC-REGISTRATION? :INITARG :DYNAMIC-REGISTRATION :DOCUMENTATION "*
* Execute command supports dynamic registration."
                        :TYPE COMMON-LISP:BOOLEAN :READER EXECUTE-COMMAND-CLIENT-CAPABILITIES-DYNAMIC-REGISTRATION)))

(COMMON-LISP:DEFCLASS EXECUTE-COMMAND-OPTIONS (WORK-DONE-PROGRESS-OPTIONS)
                      ((COMMANDS :INITARG :COMMANDS :DOCUMENTATION "*
* The commands to be executed on the server"
                        :TYPE (LEM-LSP-MODE/TYPE:TS-ARRAY COMMON-LISP:STRING) :READER EXECUTE-COMMAND-OPTIONS-COMMANDS)))
...
* Arguments that the command should be invoked with."
                        :TYPE (LEM-LSP-MODE/TYPE:TS-ARRAY COMMON-LISP:T) :READER EXECUTE-COMMAND-PARAMS-ARGUMENTS)))

(COMMON-LISP:DEFCLASS APPLY-WORKSPACE-EDIT-PARAMS (LEM-LSP-MODE/JSON:OBJECT)
...
(COMMON-LISP:DEFCLASS APPLY-WORKSPACE-EDIT-RESPONSE (LEM-LSP-MODE/JSON:OBJECT)
...
* triggered the edit."
                        :TYPE COMMON-LISP:STRING :READER APPLY-WORKSPACE-EDIT-RESPONSE-FAILURE-REASON)))
...
(COMMON-LISP:DEFCLASS TEXT-DOCUMENT-SYNC-OPTIONS (LEM-LSP-MODE/JSON:OBJECT)
...
(COMMON-LISP:DEFCLASS DID-OPEN-TEXT-DOCUMENT-PARAMS (LEM-LSP-MODE/JSON:OBJECT)
                      ((TEXT-DOCUMENT :INITARG :TEXT-DOCUMENT :DOCUMENTATION "*
* The document that was opened."
                        :TYPE TEXT-DOCUMENT-ITEM :READER DID-OPEN-TEXT-DOCUMENT-PARAMS-TEXT-DOCUMENT)))
...
* and TextDocumentSyncKind.Incremental."
                        :TYPE TEXT-DOCUMENT-SYNC-KIND :READER TEXT-DOCUMENT-CHANGE-REGISTRATION-OPTIONS-SYNC-KIND)))

(COMMON-LISP:DEFCLASS DID-CHANGE-TEXT-DOCUMENT-PARAMS (LEM-LSP-MODE/JSON:OBJECT)
                      ((TEXT-DOCUMENT :INITARG :TEXT-DOCUMENT :DOCUMENTATION "*
* The document that did change. The version number points
* to the version after all provided content changes have
* been applied."
                        :TYPE VERSIONED-TEXT-DOCUMENT-IDENTIFIER :READER DID-CHANGE-TEXT-DOCUMENT-PARAMS-TEXT-DOCUMENT)
...
*   you receive them."
                        :TYPE (LEM-LSP-MODE/TYPE:TS-ARRAY TEXT-DOCUMENT-CONTENT-CHANGE-EVENT) :READER DID-CHANGE-TEXT-DOCUMENT-PARAMS-CONTENT-CHANGES)))

(COMMON-LISP:DEFTYPE TEXT-DOCUMENT-CONTENT-CHANGE-EVENT ()
  '(COMMON-LISP:OR
    (LEM-LSP-MODE/TYPE:TS-INTERFACE ("range" :TYPE RANGE :OPTIONAL-P COMMON-LISP:NIL) ("rangeLength" :TYPE COMMON-LISP:NUMBER :OPTIONAL-P COMMON-LISP:T)
     ("text" :TYPE COMMON-LISP:STRING :OPTIONAL-P COMMON-LISP:NIL))
    (LEM-LSP-MODE/TYPE:TS-INTERFACE ("text" :TYPE COMMON-LISP:STRING :OPTIONAL-P COMMON-LISP:NIL))))

(COMMON-LISP:DEFCLASS WILL-SAVE-TEXT-DOCUMENT-PARAMS (LEM-LSP-MODE/JSON:OBJECT)
                      ((TEXT-DOCUMENT :INITARG :TEXT-DOCUMENT :DOCUMENTATION "*
* The document that will be saved."
                        :TYPE TEXT-DOCUMENT-IDENTIFIER :READER WILL-SAVE-TEXT-DOCUMENT-PARAMS-TEXT-DOCUMENT)
...
(COMMON-LISP:DEFCLASS SAVE-OPTIONS (LEM-LSP-MODE/JSON:OBJECT)
...
(COMMON-LISP:DEFCLASS TEXT-DOCUMENT-SAVE-REGISTRATION-OPTIONS (TEXT-DOCUMENT-REGISTRATION-OPTIONS)
                      ((INCLUDE-TEXT? :INITARG :INCLUDE-TEXT :DOCUMENTATION "*
* The client is supposed to include the content on save."
                        :TYPE COMMON-LISP:BOOLEAN :READER TEXT-DOCUMENT-SAVE-REGISTRATION-OPTIONS-INCLUDE-TEXT)))

(COMMON-LISP:DEFCLASS DID-SAVE-TEXT-DOCUMENT-PARAMS (LEM-LSP-MODE/JSON:OBJECT)
                      ((TEXT-DOCUMENT :INITARG :TEXT-DOCUMENT :DOCUMENTATION "*
* The document that was saved."
                        :TYPE TEXT-DOCUMENT-IDENTIFIER :READER DID-SAVE-TEXT-DOCUMENT-PARAMS-TEXT-DOCUMENT)
                       (TEXT? :INITARG :TEXT :DOCUMENTATION "*
* Optional the content when saved. Depends on the includeText value
* when the save notification was requested."
                        :TYPE COMMON-LISP:STRING :READER DID-SAVE-TEXT-DOCUMENT-PARAMS-TEXT)))

(COMMON-LISP:DEFCLASS DID-CLOSE-TEXT-DOCUMENT-PARAMS (LEM-LSP-MODE/JSON:OBJECT)
                      ((TEXT-DOCUMENT :INITARG :TEXT-DOCUMENT :DOCUMENTATION "*
* The document that was closed."
                        :TYPE TEXT-DOCUMENT-IDENTIFIER :READER DID-CLOSE-TEXT-DOCUMENT-PARAMS-TEXT-DOCUMENT)))

(COMMON-LISP:DEFCLASS TEXT-DOCUMENT-SYNC-CLIENT-CAPABILITIES (LEM-LSP-MODE/JSON:OBJECT)
                      ((DYNAMIC-REGISTRATION? :INITARG :DYNAMIC-REGISTRATION :DOCUMENTATION "*
* Whether text document synchronization supports dynamic registration."
                        :TYPE COMMON-LISP:BOOLEAN :READER TEXT-DOCUMENT-SYNC-CLIENT-CAPABILITIES-DYNAMIC-REGISTRATION)
                       (WILL-SAVE? :INITARG :WILL-SAVE :DOCUMENTATION "*
* The client supports sending will save notifications."
                        :TYPE COMMON-LISP:BOOLEAN :READER TEXT-DOCUMENT-SYNC-CLIENT-CAPABILITIES-WILL-SAVE)
                       (WILL-SAVE-WAIT-UNTIL? :INITARG :WILL-SAVE-WAIT-UNTIL :DOCUMENTATION "*
* The client supports sending a will save request and
* waits for a response providing text edits which will
* be applied to the document before it is saved."
                        :TYPE COMMON-LISP:BOOLEAN :READER TEXT-DOCUMENT-SYNC-CLIENT-CAPABILITIES-WILL-SAVE-WAIT-UNTIL)
                       (DID-SAVE? :INITARG :DID-SAVE :DOCUMENTATION "*
* The client supports did save notifications."
                        :TYPE COMMON-LISP:BOOLEAN :READER TEXT-DOCUMENT-SYNC-CLIENT-CAPABILITIES-DID-SAVE)))
...
* sent."
                        :TYPE COMMON-LISP:BOOLEAN :READER TEXT-DOCUMENT-SYNC-OPTIONS-WILL-SAVE-WAIT-UNTIL)
                       (SAVE? :INITARG :SAVE :DOCUMENTATION "*
* If present save notifications are sent to the server. If omitted the notification should not be
* sent."
                        :TYPE (COMMON-LISP:OR COMMON-LISP:BOOLEAN SAVE-OPTIONS) :READER TEXT-DOCUMENT-SYNC-OPTIONS-SAVE)))

(COMMON-LISP:DEFCLASS PUBLISH-DIAGNOSTICS-CLIENT-CAPABILITIES (LEM-LSP-MODE/JSON:OBJECT)
                      ((RELATED-INFORMATION? :INITARG :RELATED-INFORMATION :DOCUMENTATION "*
* Whether the clients accepts diagnostics with related information."
                        :TYPE COMMON-LISP:BOOLEAN :READER PUBLISH-DIAGNOSTICS-CLIENT-CAPABILITIES-RELATED-INFORMATION)
                       (TAG-SUPPORT? :INITARG :TAG-SUPPORT :DOCUMENTATION "*
* Client supports the tag property to provide meta data about a diagnostic.
* Clients supporting tags have to handle unknown tags gracefully.
*
* @since 3.15.0"
                        :TYPE (LEM-LSP-MODE/TYPE:TS-INTERFACE ("valueSet" :TYPE (LEM-LSP-MODE/TYPE:TS-ARRAY DIAGNOSTIC-TAG) :OPTIONAL-P COMMON-LISP:NIL)) :READER
                        PUBLISH-DIAGNOSTICS-CLIENT-CAPABILITIES-TAG-SUPPORT)
...
*
* @since 3.15.0"
                        :TYPE COMMON-LISP:BOOLEAN :READER PUBLISH-DIAGNOSTICS-CLIENT-CAPABILITIES-VERSION-SUPPORT)))

(COMMON-LISP:DEFCLASS PUBLISH-DIAGNOSTICS-PARAMS (LEM-LSP-MODE/JSON:OBJECT)
                      ((URI :INITARG :URI :DOCUMENTATION "*
...
* An array of diagnostic information items."
                        :TYPE (LEM-LSP-MODE/TYPE:TS-ARRAY DIAGNOSTIC) :READER PUBLISH-DIAGNOSTICS-PARAMS-DIAGNOSTICS)))

(COMMON-LISP:DEFCLASS COMPLETION-CLIENT-CAPABILITIES (LEM-LSP-MODE/JSON:OBJECT)
                      ((DYNAMIC-REGISTRATION? :INITARG :DYNAMIC-REGISTRATION :DOCUMENTATION "*
* Whether completion supports dynamic registration."
                        :TYPE COMMON-LISP:BOOLEAN :READER COMPLETION-CLIENT-CAPABILITIES-DYNAMIC-REGISTRATION)
...
* capabilities."
                        ...
                        (LEM-LSP-MODE/TYPE:TS-INTERFACE ("snippetSupport" :TYPE COMMON-LISP:BOOLEAN :OPTIONAL-P COMMON-LISP:T)
                         ...
                         ("deprecatedSupport" :TYPE COMMON-LISP:BOOLEAN :OPTIONAL-P COMMON-LISP:T) ("preselectSupport" :TYPE COMMON-LISP:BOOLEAN :OPTIONAL-P COMMON-LISP:T)
                         ("tagSupport" :TYPE (LEM-LSP-MODE/TYPE:TS-INTERFACE ("valueSet" :TYPE (LEM-LSP-MODE/TYPE:TS-ARRAY COMPLETION-ITEM-TAG) :OPTIONAL-P COMMON-LISP:NIL))
                       ...
                       (COMPLETION-ITEM-KIND? :INITARG :COMPLETION-ITEM-KIND :DOCUMENTATION "" :TYPE
                        (LEM-LSP-MODE/TYPE:TS-INTERFACE ("valueSet" :TYPE (LEM-LSP-MODE/TYPE:TS-ARRAY COMPLETION-ITEM-KIND) :OPTIONAL-P COMMON-LISP:T)) :READER
                        COMPLETION-CLIENT-CAPABILITIES-COMPLETION-ITEM-KIND)
                       (CONTEXT-SUPPORT? :INITARG :CONTEXT-SUPPORT :DOCUMENTATION "*
* The client supports to send additional context information for a
* `textDocument/completion` request."
                        :TYPE COMMON-LISP:BOOLEAN :READER COMPLETION-CLIENT-CAPABILITIES-CONTEXT-SUPPORT)))
...
* an identifier (for example `.` in JavaScript) list them in `triggerCharacters`."
                        :TYPE (LEM-LSP-MODE/TYPE:TS-ARRAY COMMON-LISP:STRING) :READER COMPLETION-OPTIONS-TRIGGER-CHARACTERS)
...
*
* @since 3.2.0"
                        :TYPE (LEM-LSP-MODE/TYPE:TS-ARRAY COMMON-LISP:STRING) :READER COMPLETION-OPTIONS-ALL-COMMIT-CHARACTERS)
...
(COMMON-LISP:DEFCLASS COMPLETION-CONTEXT (LEM-LSP-MODE/JSON:OBJECT)
...
(COMMON-LISP:DEFCLASS COMPLETION-LIST (LEM-LSP-MODE/JSON:OBJECT)
...
* The completion items."
                        :TYPE (LEM-LSP-MODE/TYPE:TS-ARRAY COMPLETION-ITEM) :READER COMPLETION-LIST-ITEMS)))
...
(COMMON-LISP:DEFTYPE INSERT-TEXT-FORMAT () '(COMMON-LISP:OR (LEM-LSP-MODE/TYPE:TS-EQUAL-SPECIALIZER 1) (LEM-LSP-MODE/TYPE:TS-EQUAL-SPECIALIZER 2)))

(COMMON-LISP:PROGN (COMMON-LISP:DEFPARAMETER COMPLETION-ITEM-TAG.DEPRECATED 1))

(COMMON-LISP:DEFTYPE COMPLETION-ITEM-TAG () '(LEM-LSP-MODE/TYPE:TS-EQUAL-SPECIALIZER 1))

(COMMON-LISP:DEFCLASS COMPLETION-ITEM (LEM-LSP-MODE/JSON:OBJECT)
                      ((LABEL :INITARG :LABEL :DOCUMENTATION "*
...
*
* @since 3.15.0"
                        :TYPE (LEM-LSP-MODE/TYPE:TS-ARRAY COMPLETION-ITEM-TAG) :READER COMPLETION-ITEM-TAGS)
...
* A human-readable string that represents a doc-comment."
                        :TYPE (COMMON-LISP:OR COMMON-LISP:STRING MARKUP-CONTENT) :READER COMPLETION-ITEM-DOCUMENTATION)
...
* insert an unqualified type)."
                        :TYPE (LEM-LSP-MODE/TYPE:TS-ARRAY TEXT-EDIT) :READER COMPLETION-ITEM-ADDITIONAL-TEXT-EDITS)
                       (COMMIT-CHARACTERS? :INITARG :COMMIT-CHARACTERS :DOCUMENTATION "*
* An optional set of characters that when pressed while this completion is active will accept it first and
* then type that character. *Note* that all commit characters should have `length=1` and that superfluous
* characters will be ignored."
                        :TYPE (LEM-LSP-MODE/TYPE:TS-ARRAY COMMON-LISP:STRING) :READER COMPLETION-ITEM-COMMIT-CHARACTERS)
                       (COMMAND? :INITARG :COMMAND :DOCUMENTATION "*
...
(COMMON-LISP:DEFCLASS HOVER-CLIENT-CAPABILITIES (LEM-LSP-MODE/JSON:OBJECT)
                      ((DYNAMIC-REGISTRATION? :INITARG :DYNAMIC-REGISTRATION :DOCUMENTATION "*
* Whether hover supports dynamic registration."
                        :TYPE COMMON-LISP:BOOLEAN :READER HOVER-CLIENT-CAPABILITIES-DYNAMIC-REGISTRATION)
                       (CONTENT-FORMAT? :INITARG :CONTENT-FORMAT :DOCUMENTATION "*
* Client supports the follow content formats for the content
* property. The order describes the preferred format of the client."
                        :TYPE (LEM-LSP-MODE/TYPE:TS-ARRAY MARKUP-KIND) :READER HOVER-CLIENT-CAPABILITIES-CONTENT-FORMAT)))
...
(COMMON-LISP:DEFCLASS HOVER (LEM-LSP-MODE/JSON:OBJECT)
                      ((CONTENTS :INITARG :CONTENTS :DOCUMENTATION "*
* The hover's content"
                        :TYPE (COMMON-LISP:OR MARKED-STRING (LEM-LSP-MODE/TYPE:TS-ARRAY MARKED-STRING) MARKUP-CONTENT) :READER HOVER-CONTENTS)
                       (RANGE? :INITARG :RANGE :DOCUMENTATION "*
...
(COMMON-LISP:DEFTYPE MARKED-STRING ()
  '(COMMON-LISP:OR COMMON-LISP:STRING
                   (LEM-LSP-MODE/TYPE:TS-INTERFACE ("language" :TYPE COMMON-LISP:STRING :OPTIONAL-P COMMON-LISP:NIL) ("value" :TYPE COMMON-LISP:STRING :OPTIONAL-P COMMON-LISP:NIL))))

(COMMON-LISP:DEFCLASS SIGNATURE-HELP-CLIENT-CAPABILITIES (LEM-LSP-MODE/JSON:OBJECT)
                      ((DYNAMIC-REGISTRATION? :INITARG :DYNAMIC-REGISTRATION :DOCUMENTATION "*
* Whether signature help supports dynamic registration."
                        :TYPE COMMON-LISP:BOOLEAN :READER SIGNATURE-HELP-CLIENT-CAPABILITIES-DYNAMIC-REGISTRATION)
...
* specific properties."
                        ...
                        (LEM-LSP-MODE/TYPE:TS-INTERFACE ("documentationFormat" :TYPE (LEM-LSP-MODE/TYPE:TS-ARRAY MARKUP-KIND) :OPTIONAL-P COMMON-LISP:T)
                         ("parameterInformation" :TYPE (LEM-LSP-MODE/TYPE:TS-INTERFACE ("labelOffsetSupport" :TYPE COMMON-LISP:BOOLEAN :OPTIONAL-P COMMON-LISP:T)) :OPTIONAL-P
                          COMMON-LISP:T))
...
*
* @since 3.15.0"
                        :TYPE COMMON-LISP:BOOLEAN :READER SIGNATURE-HELP-CLIENT-CAPABILITIES-CONTEXT-SUPPORT)))

(COMMON-LISP:DEFCLASS SIGNATURE-HELP-OPTIONS (WORK-DONE-PROGRESS-OPTIONS)
                      ((TRIGGER-CHARACTERS? :INITARG :TRIGGER-CHARACTERS :DOCUMENTATION "*
* The characters that trigger signature help
* automatically."
                        :TYPE (LEM-LSP-MODE/TYPE:TS-ARRAY COMMON-LISP:STRING) :READER SIGNATURE-HELP-OPTIONS-TRIGGER-CHARACTERS)
...
*
* @since 3.15.0"
                        :TYPE (LEM-LSP-MODE/TYPE:TS-ARRAY COMMON-LISP:STRING) :READER SIGNATURE-HELP-OPTIONS-RETRIGGER-CHARACTERS)))
...
(COMMON-LISP:DEFCLASS SIGNATURE-HELP-CONTEXT (LEM-LSP-MODE/JSON:OBJECT)
                      ((TRIGGER-KIND :INITARG :TRIGGER-KIND :DOCUMENTATION "*
* Action that caused signature help to be triggered."
                        :TYPE SIGNATURE-HELP-TRIGGER-KIND :READER SIGNATURE-HELP-CONTEXT-TRIGGER-KIND)
                       (TRIGGER-CHARACTER? :INITARG :TRIGGER-CHARACTER :DOCUMENTATION "*
...
(COMMON-LISP:DEFCLASS SIGNATURE-HELP (LEM-LSP-MODE/JSON:OBJECT)
                      ((SIGNATURES :INITARG :SIGNATURES :DOCUMENTATION "*
* One or more signatures. If no signaures are availabe the signature help
* request should return `null`."
                        :TYPE (LEM-LSP-MODE/TYPE:TS-ARRAY SIGNATURE-INFORMATION) :READER SIGNATURE-HELP-SIGNATURES)
...
(COMMON-LISP:DEFCLASS SIGNATURE-INFORMATION (LEM-LSP-MODE/JSON:OBJECT)
                      ((LABEL :INITARG :LABEL :DOCUMENTATION "*
...
* in the UI but can be omitted."
                        :TYPE (COMMON-LISP:OR COMMON-LISP:STRING MARKUP-CONTENT) :READER SIGNATURE-INFORMATION-DOCUMENTATION)
                       (PARAMETERS? :INITARG :PARAMETERS :DOCUMENTATION "*
* The parameters of this signature."
                        :TYPE (LEM-LSP-MODE/TYPE:TS-ARRAY PARAMETER-INFORMATION) :READER SIGNATURE-INFORMATION-PARAMETERS)))

(COMMON-LISP:DEFCLASS PARAMETER-INFORMATION (LEM-LSP-MODE/JSON:OBJECT)
                      ((LABEL :INITARG :LABEL :DOCUMENTATION "*
...
* Its intended use case is to highlight the parameter label part in the `SignatureInformation.label`."
                        :TYPE (COMMON-LISP:OR COMMON-LISP:STRING (LEM-LSP-MODE/TYPE:TS-TUPLE COMMON-LISP:NUMBER COMMON-LISP:NUMBER)) :READER PARAMETER-INFORMATION-LABEL)
                       (DOCUMENTATION? :INITARG :DOCUMENTATION :DOCUMENTATION "*
* The human-readable doc-comment of this parameter. Will be shown
* in the UI but can be omitted."
                        :TYPE (COMMON-LISP:OR COMMON-LISP:STRING MARKUP-CONTENT) :READER PARAMETER-INFORMATION-DOCUMENTATION)))

(COMMON-LISP:DEFCLASS DECLARATION-CLIENT-CAPABILITIES (LEM-LSP-MODE/JSON:OBJECT)
                      ((DYNAMIC-REGISTRATION? :INITARG :DYNAMIC-REGISTRATION :DOCUMENTATION "*
* Whether declaration supports dynamic registration. If this is set to `true`
* the client supports the new `DeclarationRegistrationOptions` return value
* for the corresponding server capability as well."
                        :TYPE COMMON-LISP:BOOLEAN :READER DECLARATION-CLIENT-CAPABILITIES-DYNAMIC-REGISTRATION)
                       (LINK-SUPPORT? :INITARG :LINK-SUPPORT :DOCUMENTATION "*
* The client supports additional metadata in the form of declaration links."
                        :TYPE COMMON-LISP:BOOLEAN :READER DECLARATION-CLIENT-CAPABILITIES-LINK-SUPPORT)))
...
(COMMON-LISP:DEFCLASS DEFINITION-CLIENT-CAPABILITIES (LEM-LSP-MODE/JSON:OBJECT)
                      ((DYNAMIC-REGISTRATION? :INITARG :DYNAMIC-REGISTRATION :DOCUMENTATION "*
* Whether definition supports dynamic registration."
                        :TYPE COMMON-LISP:BOOLEAN :READER DEFINITION-CLIENT-CAPABILITIES-DYNAMIC-REGISTRATION)
                       (LINK-SUPPORT? :INITARG :LINK-SUPPORT :DOCUMENTATION "*
* The client supports additional metadata in the form of definition links.
*
* @since 3.14.0"
                        :TYPE COMMON-LISP:BOOLEAN :READER DEFINITION-CLIENT-CAPABILITIES-LINK-SUPPORT)))
...
(COMMON-LISP:DEFCLASS TYPE-DEFINITION-CLIENT-CAPABILITIES (LEM-LSP-MODE/JSON:OBJECT)
                      ((DYNAMIC-REGISTRATION? :INITARG :DYNAMIC-REGISTRATION :DOCUMENTATION "*
* Whether implementation supports dynamic registration. If this is set to `true`
* the client supports the new `TypeDefinitionRegistrationOptions` return value
* for the corresponding server capability as well."
                        :TYPE COMMON-LISP:BOOLEAN :READER TYPE-DEFINITION-CLIENT-CAPABILITIES-DYNAMIC-REGISTRATION)
                       (LINK-SUPPORT? :INITARG :LINK-SUPPORT :DOCUMENTATION "*
* The client supports additional metadata in the form of definition links.
*
* @since 3.14.0"
                        :TYPE COMMON-LISP:BOOLEAN :READER TYPE-DEFINITION-CLIENT-CAPABILITIES-LINK-SUPPORT)))
...
(COMMON-LISP:DEFCLASS IMPLEMENTATION-CLIENT-CAPABILITIES (LEM-LSP-MODE/JSON:OBJECT)
                      ((DYNAMIC-REGISTRATION? :INITARG :DYNAMIC-REGISTRATION :DOCUMENTATION "*
* Whether implementation supports dynamic registration. If this is set to `true`
* the client supports the new `ImplementationRegistrationOptions` return value
* for the corresponding server capability as well."
                        :TYPE COMMON-LISP:BOOLEAN :READER IMPLEMENTATION-CLIENT-CAPABILITIES-DYNAMIC-REGISTRATION)
                       (LINK-SUPPORT? :INITARG :LINK-SUPPORT :DOCUMENTATION "*
* The client supports additional metadata in the form of definition links.
*
* @since 3.14.0"
                        :TYPE COMMON-LISP:BOOLEAN :READER IMPLEMENTATION-CLIENT-CAPABILITIES-LINK-SUPPORT)))
...
(COMMON-LISP:DEFCLASS REFERENCE-CLIENT-CAPABILITIES (LEM-LSP-MODE/JSON:OBJECT)
                      ((DYNAMIC-REGISTRATION? :INITARG :DYNAMIC-REGISTRATION :DOCUMENTATION "*
* Whether references supports dynamic registration."
                        :TYPE COMMON-LISP:BOOLEAN :READER REFERENCE-CLIENT-CAPABILITIES-DYNAMIC-REGISTRATION)))
...
(COMMON-LISP:DEFCLASS REFERENCE-PARAMS (TEXT-DOCUMENT-POSITION-PARAMS WORK-DONE-PROGRESS-PARAMS PARTIAL-RESULT-PARAMS)
                      ((CONTEXT :INITARG :CONTEXT :DOCUMENTATION "" :TYPE REFERENCE-CONTEXT :READER REFERENCE-PARAMS-CONTEXT)))

(COMMON-LISP:DEFCLASS REFERENCE-CONTEXT (LEM-LSP-MODE/JSON:OBJECT)
...
(COMMON-LISP:DEFCLASS DOCUMENT-HIGHLIGHT-CLIENT-CAPABILITIES (LEM-LSP-MODE/JSON:OBJECT)
                      ((DYNAMIC-REGISTRATION? :INITARG :DYNAMIC-REGISTRATION :DOCUMENTATION "*
* Whether document highlight supports dynamic registration."
                        :TYPE COMMON-LISP:BOOLEAN :READER DOCUMENT-HIGHLIGHT-CLIENT-CAPABILITIES-DYNAMIC-REGISTRATION)))
...
(COMMON-LISP:DEFCLASS DOCUMENT-HIGHLIGHT (LEM-LSP-MODE/JSON:OBJECT)
                      ((RANGE :INITARG :RANGE :DOCUMENTATION "*
...
(COMMON-LISP:DEFCLASS DOCUMENT-SYMBOL-CLIENT-CAPABILITIES (LEM-LSP-MODE/JSON:OBJECT)
                      ((DYNAMIC-REGISTRATION? :INITARG :DYNAMIC-REGISTRATION :DOCUMENTATION "*
...
(COMMON-LISP:DEFCLASS DOCUMENT-SYMBOL (LEM-LSP-MODE/JSON:OBJECT)
                      ((NAME :INITARG :NAME :DOCUMENTATION "*
...
* Children of this symbol, e.g. properties of a class."
                        :TYPE (LEM-LSP-MODE/TYPE:TS-ARRAY DOCUMENT-SYMBOL) :READER DOCUMENT-SYMBOL-CHILDREN)))

(COMMON-LISP:DEFCLASS SYMBOL-INFORMATION (LEM-LSP-MODE/JSON:OBJECT)
                      ((NAME :INITARG :NAME :DOCUMENTATION "*
...
(COMMON-LISP:DEFCLASS CODE-ACTION-CLIENT-CAPABILITIES (LEM-LSP-MODE/JSON:OBJECT)
                      ((DYNAMIC-REGISTRATION? :INITARG :DYNAMIC-REGISTRATION :DOCUMENTATION "*
* Whether code action supports dynamic registration."
                        :TYPE COMMON-LISP:BOOLEAN :READER CODE-ACTION-CLIENT-CAPABILITIES-DYNAMIC-REGISTRATION)
...
* @since 3.8.0"
                        ...
                        (LEM-LSP-MODE/TYPE:TS-INTERFACE
                         ("codeActionKind" :TYPE (LEM-LSP-MODE/TYPE:TS-INTERFACE ("valueSet" :TYPE (LEM-LSP-MODE/TYPE:TS-ARRAY CODE-ACTION-KIND) :OPTIONAL-P COMMON-LISP:NIL))
...
* @since 3.15.0"
                        :TYPE COMMON-LISP:BOOLEAN :READER CODE-ACTION-CLIENT-CAPABILITIES-IS-PREFERRED-SUPPORT)))
...
* may list out every specific kind they provide."
                        :TYPE (LEM-LSP-MODE/TYPE:TS-ARRAY CODE-ACTION-KIND) :READER CODE-ACTION-OPTIONS-CODE-ACTION-KINDS)))
...
(COMMON-LISP:DEFCLASS CODE-ACTION-CONTEXT (LEM-LSP-MODE/JSON:OBJECT)
                      ((DIAGNOSTICS :INITARG :DIAGNOSTICS :DOCUMENTATION "*
...
* to compute code actions is the provided range."
                        :TYPE (LEM-LSP-MODE/TYPE:TS-ARRAY DIAGNOSTIC) :READER CODE-ACTION-CONTEXT-DIAGNOSTICS)
                       (ONLY? :INITARG :ONLY :DOCUMENTATION "*
* Requested kind of actions to return.
*
* Actions not of this kind are filtered out by the client before being shown. So servers
* can omit computing them."
                        :TYPE (LEM-LSP-MODE/TYPE:TS-ARRAY CODE-ACTION-KIND) :READER CODE-ACTION-CONTEXT-ONLY)))

(COMMON-LISP:DEFCLASS CODE-ACTION (LEM-LSP-MODE/JSON:OBJECT)
                      ((TITLE :INITARG :TITLE :DOCUMENTATION "*
...
* The diagnostics that this code action resolves."
                        :TYPE (LEM-LSP-MODE/TYPE:TS-ARRAY DIAGNOSTIC) :READER CODE-ACTION-DIAGNOSTICS)
...
(COMMON-LISP:DEFCLASS CODE-LENS-CLIENT-CAPABILITIES (LEM-LSP-MODE/JSON:OBJECT)
                      ((DYNAMIC-REGISTRATION? :INITARG :DYNAMIC-REGISTRATION :DOCUMENTATION "*
* Whether code lens supports dynamic registration."
                        :TYPE COMMON-LISP:BOOLEAN :READER CODE-LENS-CLIENT-CAPABILITIES-DYNAMIC-REGISTRATION)))
...
(COMMON-LISP:DEFCLASS CODE-LENS (LEM-LSP-MODE/JSON:OBJECT)
                      ((RANGE :INITARG :RANGE :DOCUMENTATION "*
...
(COMMON-LISP:DEFCLASS DOCUMENT-LINK-CLIENT-CAPABILITIES (LEM-LSP-MODE/JSON:OBJECT)
                      ((DYNAMIC-REGISTRATION? :INITARG :DYNAMIC-REGISTRATION :DOCUMENTATION "*
* Whether document link supports dynamic registration."
                        :TYPE COMMON-LISP:BOOLEAN :READER DOCUMENT-LINK-CLIENT-CAPABILITIES-DYNAMIC-REGISTRATION)
                       (TOOLTIP-SUPPORT? :INITARG :TOOLTIP-SUPPORT :DOCUMENTATION "*
* Whether the client supports the `tooltip` property on `DocumentLink`.
*
* @since 3.15.0"
                        :TYPE COMMON-LISP:BOOLEAN :READER DOCUMENT-LINK-CLIENT-CAPABILITIES-TOOLTIP-SUPPORT)))
...
(COMMON-LISP:DEFCLASS DOCUMENT-LINK (LEM-LSP-MODE/JSON:OBJECT)
                      ((RANGE :INITARG :RANGE :DOCUMENTATION "*
...
(COMMON-LISP:DEFCLASS DOCUMENT-COLOR-CLIENT-CAPABILITIES (LEM-LSP-MODE/JSON:OBJECT)
                      ((DYNAMIC-REGISTRATION? :INITARG :DYNAMIC-REGISTRATION :DOCUMENTATION "*
* Whether document color supports dynamic registration."
                        :TYPE COMMON-LISP:BOOLEAN :READER DOCUMENT-COLOR-CLIENT-CAPABILITIES-DYNAMIC-REGISTRATION)))
...
(COMMON-LISP:DEFCLASS COLOR-INFORMATION (LEM-LSP-MODE/JSON:OBJECT)
                      ((RANGE :INITARG :RANGE :DOCUMENTATION "*
...
(COMMON-LISP:DEFCLASS COLOR (LEM-LSP-MODE/JSON:OBJECT)
...
(COMMON-LISP:DEFCLASS COLOR-PRESENTATION-PARAMS (WORK-DONE-PROGRESS-PARAMS PARTIAL-RESULT-PARAMS)
                      ((TEXT-DOCUMENT :INITARG :TEXT-DOCUMENT :DOCUMENTATION "*
* The text document."
                        :TYPE TEXT-DOCUMENT-IDENTIFIER :READER COLOR-PRESENTATION-PARAMS-TEXT-DOCUMENT)
                       (COLOR :INITARG :COLOR :DOCUMENTATION "*
...
(COMMON-LISP:DEFCLASS COLOR-PRESENTATION (LEM-LSP-MODE/JSON:OBJECT)
                      ((LABEL :INITARG :LABEL :DOCUMENTATION "*
...
* selecting this color presentation. Edits must not overlap with the main [edit](#ColorPresentation.textEdit) nor with themselves."
                        :TYPE (LEM-LSP-MODE/TYPE:TS-ARRAY TEXT-EDIT) :READER COLOR-PRESENTATION-ADDITIONAL-TEXT-EDITS)))

(COMMON-LISP:DEFCLASS DOCUMENT-FORMATTING-CLIENT-CAPABILITIES (LEM-LSP-MODE/JSON:OBJECT)
                      ((DYNAMIC-REGISTRATION? :INITARG :DYNAMIC-REGISTRATION :DOCUMENTATION "*
* Whether formatting supports dynamic registration."
                        :TYPE COMMON-LISP:BOOLEAN :READER DOCUMENT-FORMATTING-CLIENT-CAPABILITIES-DYNAMIC-REGISTRATION)))
...
* The document to format."
                        :TYPE TEXT-DOCUMENT-IDENTIFIER :READER DOCUMENT-FORMATTING-PARAMS-TEXT-DOCUMENT)
                       (OPTIONS :INITARG :OPTIONS :DOCUMENTATION "*
* The format options."
                        :TYPE FORMATTING-OPTIONS :READER DOCUMENT-FORMATTING-PARAMS-OPTIONS)))

(COMMON-LISP:DEFCLASS FORMATTING-OPTIONS (LEM-LSP-MODE/JSON:OBJECT)
...
*
* @since 3.15.0"
                        :TYPE COMMON-LISP:BOOLEAN :READER FORMATTING-OPTIONS-TRIM-TRAILING-WHITESPACE)
...
* Signature for further properties."
                        :TYPE (LEM-LSP-MODE/TYPE:TS-OBJECT COMMON-LISP:STRING (COMMON-LISP:OR COMMON-LISP:BOOLEAN COMMON-LISP:NUMBER COMMON-LISP:STRING)) :READER
                        FORMATTING-OPTIONS-KEY)))

(COMMON-LISP:DEFCLASS DOCUMENT-RANGE-FORMATTING-CLIENT-CAPABILITIES (LEM-LSP-MODE/JSON:OBJECT)
                      ((DYNAMIC-REGISTRATION? :INITARG :DYNAMIC-REGISTRATION :DOCUMENTATION "*
* Whether formatting supports dynamic registration."
                        :TYPE COMMON-LISP:BOOLEAN :READER DOCUMENT-RANGE-FORMATTING-CLIENT-CAPABILITIES-DYNAMIC-REGISTRATION)))
...
(COMMON-LISP:DEFCLASS DOCUMENT-RANGE-FORMATTING-PARAMS (WORK-DONE-PROGRESS-PARAMS)
                      ((TEXT-DOCUMENT :INITARG :TEXT-DOCUMENT :DOCUMENTATION "*
* The document to format."
                        :TYPE TEXT-DOCUMENT-IDENTIFIER :READER DOCUMENT-RANGE-FORMATTING-PARAMS-TEXT-DOCUMENT)
                       (RANGE :INITARG :RANGE :DOCUMENTATION "*
* The range to format"
...
(COMMON-LISP:DEFCLASS DOCUMENT-ON-TYPE-FORMATTING-CLIENT-CAPABILITIES (LEM-LSP-MODE/JSON:OBJECT)
                      ((DYNAMIC-REGISTRATION? :INITARG :DYNAMIC-REGISTRATION :DOCUMENTATION "*
* Whether on type formatting supports dynamic registration."
                        :TYPE COMMON-LISP:BOOLEAN :READER DOCUMENT-ON-TYPE-FORMATTING-CLIENT-CAPABILITIES-DYNAMIC-REGISTRATION)))

(COMMON-LISP:DEFCLASS DOCUMENT-ON-TYPE-FORMATTING-OPTIONS (LEM-LSP-MODE/JSON:OBJECT)
                      ((FIRST-TRIGGER-CHARACTER :INITARG :FIRST-TRIGGER-CHARACTER :DOCUMENTATION "*
* A character on which formatting should be triggered, like `}`."
                        :TYPE COMMON-LISP:STRING :READER DOCUMENT-ON-TYPE-FORMATTING-OPTIONS-FIRST-TRIGGER-CHARACTER)
                       (MORE-TRIGGER-CHARACTER? :INITARG :MORE-TRIGGER-CHARACTER :DOCUMENTATION "*
* More trigger characters."
                        :TYPE (LEM-LSP-MODE/TYPE:TS-ARRAY COMMON-LISP:STRING) :READER DOCUMENT-ON-TYPE-FORMATTING-OPTIONS-MORE-TRIGGER-CHARACTER)))
...
(COMMON-LISP:DEFCLASS RENAME-CLIENT-CAPABILITIES (LEM-LSP-MODE/JSON:OBJECT)
                      ((DYNAMIC-REGISTRATION? :INITARG :DYNAMIC-REGISTRATION :DOCUMENTATION "*
* Whether rename supports dynamic registration."
                        :TYPE COMMON-LISP:BOOLEAN :READER RENAME-CLIENT-CAPABILITIES-DYNAMIC-REGISTRATION)
                       (PREPARE-SUPPORT? :INITARG :PREPARE-SUPPORT :DOCUMENTATION "*
* Client supports testing for validity of rename operations
* before execution.
*
* @since version 3.12.0"
                        :TYPE COMMON-LISP:BOOLEAN :READER RENAME-CLIENT-CAPABILITIES-PREPARE-SUPPORT)))
...
(COMMON-LISP:DEFCLASS FOLDING-RANGE-CLIENT-CAPABILITIES (LEM-LSP-MODE/JSON:OBJECT)
                      ((DYNAMIC-REGISTRATION? :INITARG :DYNAMIC-REGISTRATION :DOCUMENTATION "*
* Whether implementation supports dynamic registration for folding range providers. If this is set to `true`
* the client supports the new `FoldingRangeRegistrationOptions` return value for the corresponding server
* capability as well."
                        :TYPE COMMON-LISP:BOOLEAN :READER FOLDING-RANGE-CLIENT-CAPABILITIES-DYNAMIC-REGISTRATION)
                       (RANGE-LIMIT? :INITARG :RANGE-LIMIT :DOCUMENTATION "*
* The maximum number of folding ranges that the client prefers to receive per document. The value serves as a
* hint, servers are free to follow the limit."
                        :TYPE COMMON-LISP:NUMBER :READER FOLDING-RANGE-CLIENT-CAPABILITIES-RANGE-LIMIT)
                       (LINE-FOLDING-ONLY? :INITARG :LINE-FOLDING-ONLY :DOCUMENTATION "*
* If set, the client signals that it only supports folding complete lines. If set, client will
* ignore specified `startCharacter` and `endCharacter` properties in a FoldingRange."
                        :TYPE COMMON-LISP:BOOLEAN :READER FOLDING-RANGE-CLIENT-CAPABILITIES-LINE-FOLDING-ONLY)))
...
(COMMON-LISP:DEFCLASS FOLDING-RANGE (LEM-LSP-MODE/JSON:OBJECT)
...
(COMMON-LISP:DEFCLASS SELECTION-RANGE-CLIENT-CAPABILITIES (LEM-LSP-MODE/JSON:OBJECT)
                      ((DYNAMIC-REGISTRATION? :INITARG :DYNAMIC-REGISTRATION :DOCUMENTATION "*
* Whether implementation supports dynamic registration for selection range providers. If this is set to `true`
* the client supports the new `SelectionRangeRegistrationOptions` return value for the corresponding server
* capability as well."
                        :TYPE COMMON-LISP:BOOLEAN :READER SELECTION-RANGE-CLIENT-CAPABILITIES-DYNAMIC-REGISTRATION)))
...
* The positions inside the text document."
                        :TYPE (LEM-LSP-MODE/TYPE:TS-ARRAY POSITION) :READER SELECTION-RANGE-PARAMS-POSITIONS)))

(COMMON-LISP:DEFCLASS SELECTION-RANGE (LEM-LSP-MODE/JSON:OBJECT)
                      ((RANGE :INITARG :RANGE :DOCUMENTATION "*
