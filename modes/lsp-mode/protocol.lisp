;;; Code generated by LEM-LSP-MODE/MAIN; DO NOT EDIT.
...
* Holds changes to existing resources."
                        ...
                        (LEM-LSP-MODE/TYPE:INTERFACE
                         ("uri" :TYPE (LEM-LSP-MODE/TYPE:OBJECT DOCUMENT-URI (LEM-LSP-MODE/TYPE:LSP-ARRAY TEXT-EDIT)))))
...
* only plain `TextEdit`s using the `changes` property are supported."
                        :TYPE
                        (COMMON-LISP:OR (LEM-LSP-MODE/TYPE:LSP-ARRAY TEXT-DOCUMENT-EDIT)
                                        (LEM-LSP-MODE/TYPE:LSP-ARRAY
...
* The initial trace setting. If omitted trace is disabled ('off')."
                        :TYPE
                        (COMMON-LISP:OR (LEM-LSP-MODE/TYPE:EQUAL-SPECIALIZER "off") (LEM-LSP-MODE/TYPE:EQUAL-SPECIALIZER "messages")
                                        (LEM-LSP-MODE/TYPE:EQUAL-SPECIALIZER "verbose")))
...
* Workspace specific client capabilities."
                        :TYPE
                        (LEM-LSP-MODE/TYPE:INTERFACE ("applyEdit" :TYPE COMMON-LISP:BOOLEAN)
...
(COMMON-LISP:DEFCLASS REGISTRATION-PARAMS (LEM-LSP-MODE/JSON:OBJECT)
                      ((REGISTRATIONS :INITARG :REGISTRATIONS :DOCUMENTATION "" :TYPE (LEM-LSP-MODE/TYPE:LSP-ARRAY REGISTRATION))))
...
(COMMON-LISP:DEFCLASS CONFIGURATION-PARAMS (LEM-LSP-MODE/JSON:OBJECT)
                      ((ITEMS :INITARG :ITEMS :DOCUMENTATION "" :TYPE (LEM-LSP-MODE/TYPE:LSP-ARRAY CONFIGURATION-ITEM))))
...
* capabilities."
                        :TYPE
                        (LEM-LSP-MODE/TYPE:INTERFACE ("snippetSupport" :TYPE COMMON-LISP:BOOLEAN)
                         ("commitCharactersSupport" :TYPE COMMON-LISP:BOOLEAN)
                         ("documentationFormat" :TYPE (LEM-LSP-MODE/TYPE:LSP-ARRAY MARKUP-KIND))
                         ("deprecatedSupport" :TYPE COMMON-LISP:BOOLEAN) ("preselectSupport" :TYPE COMMON-LISP:BOOLEAN)
                         ("tagSupport" :TYPE
                          (LEM-LSP-MODE/TYPE:INTERFACE ("valueSet" :TYPE (LEM-LSP-MODE/TYPE:LSP-ARRAY COMPLETION-ITEM-TAG))))))
                       (COMPLETION-ITEM-KIND? :INITARG :COMPLETION-ITEM-KIND :DOCUMENTATION "" :TYPE
                        (LEM-LSP-MODE/TYPE:INTERFACE ("valueSet" :TYPE (LEM-LSP-MODE/TYPE:LSP-ARRAY COMPLETION-ITEM-KIND))))
...
* specific properties."
                        ...
                        (LEM-LSP-MODE/TYPE:INTERFACE ("documentationFormat" :TYPE (LEM-LSP-MODE/TYPE:LSP-ARRAY MARKUP-KIND))
                         ("parameterInformation" :TYPE
                          (LEM-LSP-MODE/TYPE:INTERFACE ("labelOffsetSupport" :TYPE COMMON-LISP:BOOLEAN)))))
                       (CONTEXT-SUPPORT? :INITARG :CONTEXT-SUPPORT :DOCUMENTATION "*
* The client supports to send additional context information for a
...
* @since 3.8.0"
                        ...
                        (LEM-LSP-MODE/TYPE:INTERFACE
                         ("codeActionKind" :TYPE
                          (LEM-LSP-MODE/TYPE:INTERFACE ("valueSet" :TYPE (LEM-LSP-MODE/TYPE:LSP-ARRAY CODE-ACTION-KIND))))))
...
* Signature for further properties."
                        :TYPE
                        (LEM-LSP-MODE/TYPE:OBJECT COMMON-LISP:STRING
