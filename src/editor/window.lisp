  ...
  (unless (eq (current-buffer) buffer)
    (when update-prev-buffer-p
      ...
      (let ((old-buffer (current-buffer)))
        ...
        (lem-core::buffer-clear-keep-binfo old-buffer)
        (setf (lem-core::buffer-keep-binfo old-buffer)
    ...
    (cond ((lem-core::buffer-keep-binfo buffer)
           (destructuring-bind (view-point cursor-point)
               (lem-core::buffer-keep-binfo buffer)
