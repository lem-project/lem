...
(defvar *lisp-syntax-table*
  (make-syntax-table
   ...
   :keywords `(("^block$" . ,*word-color*)
               ("^case$" . ,*word-color*)
               ("^ccase$" . ,*word-color*)
               ("^ecase$" . ,*word-color*)
               ("^typecase$" . ,*word-color*)
               ("^etypecase$" . ,*word-color*)
               ("^ctypecase$" . ,*word-color*)
               ("^catch$" . ,*word-color*)
               ("^cond$" . ,*word-color*)
               ("^defclass$" . ,*word-color*)
               ("^define-condition$" . ,*word-color*)
               ("^define-modify-macro$" . ,*word-color*)
               ("^defsetf$" . ,*word-color*)
               ("^defun$" . ,*word-color*)
               ("^define-setf-method$" . ,*word-color*)
               ("^define-setf-expander$" . ,*word-color*)
               ("^defmacro$" . ,*word-color*)
               ("^deftype$" . ,*word-color*)
               ("^defmethod$" . ,*word-color*)
               ("^defpackage$" . ,*word-color*)
               ("^defstruct$" . ,*word-color*)
               ("^destructuring-bind$" . ,*word-color*)
               ("^do$" . ,*word-color*)
               ("^do*$" . ,*word-color*)
               ("^dolist$" . ,*word-color*)
               ("^dotimes$" . ,*word-color*)
               ("^eval-when$" . ,*word-color*)
               ("^flet$" . ,*word-color*)
               ("^labels$" . ,*word-color*)
               ("^macrolet$" . ,*word-color*)
               ("^generic-flet$" . ,*word-color*)
               ("^generic-labels$" . ,*word-color*)
               ("^handler-case$" . ,*word-color*)
               ("^restart-case$" . ,*word-color*)
               ("^if$" . ,*word-color*)
               ("^lambda$" . ,*word-color*)
               ("^let$" . ,*word-color*)
               ("^let*$" . ,*word-color*)
               ("^handler-bind$" . ,*word-color*)
               ("^restart-bind$" . ,*word-color*)
               ("^locally$" . ,*word-color*)
               ("^multiple-value-bind$" . ,*word-color*)
               ("^multiple-value-call$" . ,*word-color*)
               ("^multiple-value-prog1$" . ,*word-color*)
               ("^prog$" . ,*word-color*)
               ("^prog*$" . ,*word-color*)
               ("^prog1$" . ,*word-color*)
               ("^prog2$" . ,*word-color*)
               ...
               ("^progv$" . ,*word-color*)
               ("^return$" . ,*word-color*)
               ("^return-from$" . ,*word-color*)
               ("^symbol-macrolet$" . ,*word-color*)
               ("^tagbody$" . ,*word-color*)
               ("^throw$" . ,*word-color*)
               ("^unless$" . ,*word-color*)
               ("^unwind-protect$" . ,*word-color*)
               ("^when$" . ,*word-color*)
               ("^with-accessors$" . ,*word-color*)
               ("^with-condition-restarts$" . ,*word-color*)
               ("^with-output-to-string$" . ,*word-color*)
               ("^with-slots$" . ,*word-color*)
               ("^with-standard-io-syntax$" . ,*word-color*)
               ("^defparameter$" . ,*word-color*)
               ("^defvar$" . ,*word-color*)
               ("^defconstant$" . ,*word-color*)
               ("loop" . ,*word-color*)
               ("^\\*[^*]*\\*$" . ,*symbol-color*)
               ("^:.*$" . ,*keyword-color*)
               )))
